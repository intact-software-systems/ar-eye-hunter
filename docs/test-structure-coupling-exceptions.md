...
```test-structure-coupling-registry-v1
{
  ...
  "contracts": [
    ...
    },
    {
      ...
      "owner": "Rallar server maintainers",
      "summary": "Exported mutation capabilities resolve through named, default, namespace, dynamic, and aliased imports before routing assertions run. Executable assertion: “exports a syntax-aware analyzer for named, default, namespace, dynamic, and alias evasions”.",
      "semanticCoverage": "packages/tests/repo/mutation-route-ownership/route-owner/mutation-route-owner-analysis.test.ts#exports a syntax-aware analyzer for named, default, namespace, dynamic, and alias evasions",
      "coverageRelation": "The analyzer test executes import and export resolution across each supported module form; this AST parse follows mutable capabilities to their canonical owners."
    },
    {
  ...
  "entries": [
    ...
    },
    {
      ...
      "boundary": "security",
      "owner": "Rallar server maintainers",
      "rationale": "Reads module export declarations while traversing the authoritative import graph, proving mutable capabilities remain traceable to their canonical owners.",
      "semanticCoverage": "packages/tests/repo/mutation-route-ownership/route-owner/mutation-route-owner-analysis.test.ts#exports a syntax-aware analyzer for named, default, namespace, dynamic, and alias evasions"
    },
    {
