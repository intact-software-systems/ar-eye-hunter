...
**State:** proposed and inactive. Task 4A is merged and revalidated, satisfying
this prerequisite, but neither this closure record nor Task 4A approval
activates Task 4B. Task 4B requires its own fresh branch, follow-on PR, and
explicit human start direction; B04 and capture remain held through its exit.
