...
| `RALLAR_POSTGRES_INTEGRATION` | No                                            | Disabled                                                        | `1` enables selected real-PostgreSQL shared-server integration tests, including presence-expiry concurrency and admin-prune page deletion; otherwise those tests are skipped. |
