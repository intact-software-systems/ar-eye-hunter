...
| `repo-style-structural-lineage-provenance.test.ts` | 366 |

## Structural-lineage inventory

The immutable manifest contains 17 rows and 48 unique targets. The focused provenance integrity test hard-codes this complete mapping, verifies that each target currently exists, and parses Task 3 provenance by exact source section. It rejects duplicate, missing, or misassociated targets and empty required source/target fields without trying to infer semantic truth. The approved merge base for every row is `52d973bb71dda2100455e8585a0a8f98d177bd13`.

### Exact source/target spans and changed regions

The following 48 rows complete the inventory with an exact approved-source span, an exact current-target span, and the changed region. Whole-file spans are deliberate: the immutable manifest tracks structural extraction boundaries, while Task 3 independently records and human-audits any semantic additions.

| Approved source span | Current target span | Changed region |
| --- | --- | --- |
| `packages/shared-server/rallar-system/services/AppGroupInboxService.ts` lines 1–1753 in approved blob `b7525b31bd38e24a883c69bdf97d0ef0a5232448` | `packages/shared-server/rallar-system/group-state/inbox/group-state-inbox-handler.ts` current lines 1–399 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/AppGroupInboxService.ts` lines 1–1753 in approved blob `b7525b31bd38e24a883c69bdf97d0ef0a5232448` | `packages/shared-server/rallar-system/group-state/inbox/group-state-inbox-result.ts` current lines 1–112 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/AppGroupInboxService.ts` lines 1–1753 in approved blob `b7525b31bd38e24a883c69bdf97d0ef0a5232448` | `packages/shared-server/rallar-system/rtc-topology/inbox/rtc-rtt-app-inbox-authority.ts` current lines 1–149 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/AppGroupInboxService.ts` lines 1–1753 in approved blob `b7525b31bd38e24a883c69bdf97d0ef0a5232448` | `packages/shared-server/rallar-system/topology/inbox/topology-app-inbox-authority.ts` current lines 1–183 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/AppGroupInboxService.ts` lines 1–1753 in approved blob `b7525b31bd38e24a883c69bdf97d0ef0a5232448` | `packages/shared-server/rallar-system/topology/inbox/topology-app-inbox-command.ts` current lines 1–341 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/AppGroupInboxService.ts` lines 1–1753 in approved blob `b7525b31bd38e24a883c69bdf97d0ef0a5232448` | `packages/shared-server/rallar-system/topology/inbox/topology-app-inbox-handler.ts` current lines 1–158 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-service.ts` lines 1–1283 in approved blob `3c8356ee088d2963d6f8f0f3b688bc0954d4745b` | `packages/shared-server/rallar-system/group-state/group-mutation-authority.ts` current lines 1–347 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-service.ts` lines 1–1283 in approved blob `3c8356ee088d2963d6f8f0f3b688bc0954d4745b` | `packages/shared-server/rallar-system/group-state/group-state-service.ts` current lines 1–378 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/aggregate/compute-group-aggregate-mutation.ts` current lines 1–312 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/orchestration/compute-group-mutation.ts` current lines 1–244 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/group-mutation-contracts.ts` current lines 1–325 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/command-validation/group-mutation-request-validation.ts` current lines 1–227 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/result-validation/validate-computed-group-mutation-write.ts` current lines 1–338 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/result-validation/validate-computed-group-mutation.ts` current lines 1–102 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/command-validation/validate-group-mutation-command.ts` current lines 1–314 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/command-validation/validate-group-mutation-operation-input.ts` current lines 1–166 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/state-validation/validate-group-mutation-read.ts` current lines 1–387 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/mutation/result-validation/validate-group-mutation-result.ts` current lines 1–242 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/persistence/group-state-persistence-codec.ts` current lines 1–311 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/persistence/validate-persisted-group-presence.ts` current lines 1–274 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/persistence/validate-persisted-group.ts` current lines 1–233 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-mutations.ts` lines 1–4233 in approved blob `66a5a6fcbd86a1d144a2e0a1394ee80eca2fb520` | `packages/shared-server/rallar-system/group-state/presence/compute-group-presence-summary.ts` current lines 1–301 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/repositories/GroupStateRepository.ts` lines 1–1244 in approved blob `ade6c012f1ea17ff3b3604f1bac05c6764b4f7a0` | `packages/shared-server/rallar-system/group-state/persistence/group-aggregate-repository.ts` current lines 1–292 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/repositories/GroupStateRepository.ts` lines 1–1244 in approved blob `ade6c012f1ea17ff3b3604f1bac05c6764b4f7a0` | `packages/shared-server/rallar-system/group-state/persistence/group-membership-repository.ts` current lines 1–58 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/repositories/GroupStateRepository.ts` lines 1–1244 in approved blob `ade6c012f1ea17ff3b3604f1bac05c6764b4f7a0` | `packages/shared-server/rallar-system/group-state/persistence/group-presence-repository.ts` current lines 1–221 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/repositories/GroupStateRepository.ts` lines 1–1244 in approved blob `ade6c012f1ea17ff3b3604f1bac05c6764b4f7a0` | `packages/shared-server/rallar-system/group-state/persistence/group-state-persistence-contracts.ts` current lines 1–128 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/repositories/GroupStateRepository.ts` lines 1–1244 in approved blob `ade6c012f1ea17ff3b3604f1bac05c6764b4f7a0` | `packages/shared-server/rallar-system/group-state/persistence/group-state-repository-reads.ts` current lines 1–261 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/repositories/GroupStateRepository.ts` lines 1–1244 in approved blob `ade6c012f1ea17ff3b3604f1bac05c6764b4f7a0` | `packages/shared-server/rallar-system/group-state/persistence/group-state-snapshot-repository.ts` current lines 1–302 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/app-group-ws-session-lifecycle.ts` lines 1–194 in approved blob `837714f6dc40c6572c4114490c6b366f5dec122e` | `packages/shared-server/rallar-system/group-state/presence/group-presence-service.ts` current lines 1–200 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-snapshot-validation.ts` lines 1–138 in approved blob `94e8f14c8753aca5236b7c0f968e6c945b0406e3` | `packages/shared-server/rallar-system/group-state/snapshot/validate-persisted-group-snapshot.ts` current lines 1–162 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-validation-primitives.ts` lines 1–109 in approved blob `71860577dc37f2c8fb8cf4025559a6cf0cff6bb4` | `packages/shared-server/rallar-system/group-state/group-state-validation-primitives.ts` current lines 1–101 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-state-crypto.ts` lines 1–69 in approved blob `5e804aaa083a2ca1a9f46a7ff378d33aab26ca79` | `packages/shared-server/rallar-system/group-state/mutation/group-state-crypto.ts` current lines 1–66 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-server/rallar-system/services/group-expired-state-authority.ts` lines 1–45 in approved blob `dd7adf62ec3e1e907af5133481aea04f94acfd0c` | `packages/shared-server/rallar-system/group-state/presence/group-expired-state-authority.ts` current lines 1–51 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-black-box-run.mts` lines 1–827 in approved blob `baaadae42ebe02e4d6cdd9a856f77dd8afc77c45` | `packages/shared-test/black-box-runner/managed-api/api-v1-managed-api-readiness.mts` current lines 1–393 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-black-box-run.mts` lines 1–827 in approved blob `baaadae42ebe02e4d6cdd9a856f77dd8afc77c45` | `packages/shared-test/black-box-runner/managed-api/api-v1-managed-api-redaction-patterns.mts` current lines 1–23 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-black-box-run.mts` lines 1–827 in approved blob `baaadae42ebe02e4d6cdd9a856f77dd8afc77c45` | `packages/shared-test/black-box-runner/managed-api/api-v1-managed-log-tail.mts` current lines 1–86 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-black-box-run.mts` lines 1–827 in approved blob `baaadae42ebe02e4d6cdd9a856f77dd8afc77c45` | `packages/shared-test/black-box-runner/managed-api/api-v1-managed-postgres-run-database.mts` current lines 1–79 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-black-box-run.mts` lines 1–827 in approved blob `baaadae42ebe02e4d6cdd9a856f77dd8afc77c45` | `packages/shared-test/black-box-runner/managed-api/api-v1-managed-process-lifecycle.mts` current lines 1–185 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-evidence.ts` lines 1–399 in approved blob `90f1497f1636ea8685dba92b7757f9f94e5d6088` | `packages/shared-test/black-box-runner/state-write-evidence/api-v1-state-write-evidence-contracts.ts` current lines 1–97 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-evidence.ts` lines 1–399 in approved blob `90f1497f1636ea8685dba92b7757f9f94e5d6088` | `packages/shared-test/black-box-runner/state-write-evidence/api-v1-state-write-evidence-derivation.ts` current lines 1–332 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-evidence.ts` lines 1–399 in approved blob `90f1497f1636ea8685dba92b7757f9f94e5d6088` | `packages/shared-test/black-box-runner/state-write-evidence/api-v1-state-write-evidence-source.ts` current lines 1–394 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-evidence.ts` lines 1–399 in approved blob `90f1497f1636ea8685dba92b7757f9f94e5d6088` | `packages/shared-test/black-box-runner/state-write-evidence/api-v1-state-write-evidence-sql.ts` current lines 1–178 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-group-causal-evidence.ts` lines 1–186 in approved blob `9be5158ab51c0106cf73a2f855cf97ad4eadd24b` | `packages/shared-test/black-box-runner/state-write-evidence/api-v1-state-write-group-causal-evidence.ts` current lines 1–204 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-json-evidence.ts` lines 1–35 in approved blob `9dfbd2c6a5c350ee14ba56088b3c56d62ce9ba24` | `packages/shared-test/black-box-runner/state-write-evidence/api-v1-state-write-json-evidence.ts` current lines 1–36 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-match.ts` lines 1–9 in approved blob `30af6a2b9de18b3215700b89fb0166af466fa9d3` | `packages/shared-test/black-box-runner/state-write-evidence/to-exact-persisted-evidence-matches.ts` current lines 1–10 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/api-v1-state-write-topology-result-evidence.ts` lines 1–107 in approved blob `c88f184577dfad6af825f8caa2643a0ca6dc2d9c` | `packages/shared-test/black-box-runner/state-write-evidence/validate-topology-mutation-result-payload.ts` current lines 1–132 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/artifact-report-bounds.ts` lines 1–37 in approved blob `2bf9ee11bb835ab44706d964a5caff9d0dae2f1c` | `packages/shared-test/black-box-runner/artifacts/with-bounded-artifact-report-results.ts` current lines 1–38 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
| `packages/shared-test/black-box-runner/live-preflight-variables.ts` lines 1–79 in approved blob `2ede5ae0110654cc4cae9f1e80cfe37f6b670933` | `packages/shared-test/black-box-runner/preflight/resolve-variable-by-env.ts` current lines 1–74 | Whole-file structural extraction; semantic additions are independently reviewed in Task 3. |
...
The focused integrity run has 73 tests: 68 pass and exactly five fail, all because a later planned deliverable is deliberately absent.
...
- The focused Vitest command over the PR A integrity suites was used to establish the expected RED baseline: 68 passing tests and five deliberate failures tied only to Task 2 and Task 3 deliverables. This distinguishes intended missing guidance/provenance from accidental preservation regressions.
- The provenance parser fixtures were written before the validator, then run to show the expected missing-validator RED. They cover wrong-source association, duplicate and missing targets, empty required fields, and a valid complete structure; after the minimal parser was added, only the pre-existing absent Task 3 document failure remained.
- `npm run test:repo-governance` exercised the updated deterministic registration: 183 tests passed and the same five intentional Task 2/Task 3 failures remained (188 total). No unrelated registered governance suite regressed.
