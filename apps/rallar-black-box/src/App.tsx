...
function DistributedRunMonitorPanel({
    monitor,
}: {
...
function DistributedRunComparePanel({
    runs,
    leftId,
    rightId,
    summary,
...
function distributedDiagnosticGroupValue(
...
function RunManagerCommandList({
    rows,
}: {
