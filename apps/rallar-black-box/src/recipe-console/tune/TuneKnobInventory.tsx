    ...
    return (
        ...
        >
            ...
            {outside > 0 ? (
                ...
                >{outside.toLocaleString('en-US')} blocked knobs outside this window and browseable.</p>
            ) : null}
            <span
            ...
            } of ${blocked.length.toLocaleString('en-US')} blocked knobs.`}</span>
            <ul
                id="tune-blocked-knob-evidence"
            >
