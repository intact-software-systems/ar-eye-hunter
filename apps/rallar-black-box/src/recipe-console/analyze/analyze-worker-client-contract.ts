...
export type AnalyzeCompleteResponse = Extract<
    AnalyzeWorkerResponse,
    { type: 'complete' }
>;
export type AnalyzeSearchResponse = Extract<
    AnalyzeWorkerResponse,
    { type: 'search-complete' }
>;
export type AnalyzeWindowResponse = Extract<
    AnalyzeWorkerResponse,
    { type: 'window-complete' }
>;
export type AnalyzeSelectionResponse = Extract<
    AnalyzeWorkerResponse,
    { type: 'selection-complete' }
>;
export type AnalyzeTuneResponse = Extract<
    AnalyzeWorkerResponse,
    { type: 'tune-complete' }
>;
