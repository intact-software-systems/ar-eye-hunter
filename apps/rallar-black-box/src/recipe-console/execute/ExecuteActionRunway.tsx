...
import type { ExecuteAction, ExecuteActionPolicy, ExecuteConnectionTruth } from './execute-action-policy.ts';
                ...
                {handler
                    ? (
                        <button
                            ...
                            onClick={() => {
                                recoverFocusRef.current = isDirectExecuteStep(next.step) &&
...
function primaryHandler(
    ...
    switch (step) {
        ...
        case 'resolve':
            return handlers.onResolve;
        case 'create':
            return handlers.onCreate;
        case 'stage':
            return handlers.onStage;
        case 'review-start':
            return handlers.onReviewStart;
        case 'monitor':
            return handlers.onMonitor;
        case 'connect-agents':
        case 'registering':
