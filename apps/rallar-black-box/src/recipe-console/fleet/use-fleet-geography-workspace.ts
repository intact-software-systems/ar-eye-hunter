...
export function useFleetGeographyWorkspace(
    input: Readonly<{
    ...
    const history = useMemo(() => createFleetGeographyHistoricalCollection(input.reports), [input.reportRevision]);
