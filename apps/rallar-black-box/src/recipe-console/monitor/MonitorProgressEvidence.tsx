                    ...
                    >
                        {visibleRecipes.map((recipe, offset) => {
                            ...
                            return (
                                ...
                                type="button"
                            >
                                <span><strong><ExactIdentifier value={recipe.recipeId} /></strong><small>{recipe.role ?? recipe.profile ?? 'All assigned roles'}</small></span>
                        ...
                        {visibleReadiness.map((row, offset) => {
                            ...
                            >
                                <button
                                    ...
                                    type="button"
                                ><ExactIdentifier value={row.agentId} /><span>{row.role ?? 'Participant'}</span></button>
