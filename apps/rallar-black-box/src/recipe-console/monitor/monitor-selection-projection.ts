...
import type { MonitorDistributedRunSelection, MonitorSelectionIndexWork } from './monitor-selection.ts';
...
function prepareIndex(
    ...
    const collectionMatches = input.snapshot.distributedRuns === input.distributedRuns ||
