...
export type MonitorActionPolicy = Readonly<Record<MonitorAction, MonitorActionDecision>>;
...
export function createMonitorCancelArmContext(
    input: Readonly<{
        baseUrl: string;
        controlRunId: string;
...
export function monitorConnectionTruth(
    input: Readonly<{
