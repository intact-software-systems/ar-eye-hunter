                    ...
                    <>
                        ...
                        {(localDisabledReason || distributedDisabledReason) && (
                            <div className="runner-disabled-reasons">
                                {localDisabledReason && <span>Local: {localDisabledReason}</span>}
                                {distributedDisabledReason && (
                                    <span>
                        ...
                        {firstFailure && (
                            <div className="runner-failure-focus">
                                ...
                                <small>
                                    Likely cause: {firstFailure.error?.message ??
                                        'runtime evidence did not match the recipe expectation.'}
                                </small>
                                <small>
                        ...
                        {distributedRun && (
                            <div className="distributed-run-summary runner-distributed-summary">
                                ...
                                <Metric
                                    ...
                                    tone={distributedRun.rollup.summary.blockingFailures > 0
                                        ? 'bad'
                                        : 'good'}
                                />
                            </div>
