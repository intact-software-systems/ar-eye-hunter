import { resolveDistributedRunSeedId, type DistributedRunSeedId } from '../../../distributed-run-seeds.ts';
...
export function readDistributedRunSeedFromUrl(): DistributedRunSeedId | undefined {
    ...
    return resolveDistributedRunSeedId(params.get('distributedRunSeed'));
}
