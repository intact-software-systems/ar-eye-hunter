    ...
    return (
        <section className="runner-distributed-analysis">
            <div className="section-heading">
                ...
                <span
                    className={`pill ${
                        selectedDistributedRun ? distributedRecipeStateTone(selectedDistributedRun.state) : 'muted'
                    }`}
                >
                    {distributedBusy ??
            ...
            <div className="runner-distributed-toolbar">
                ...
                <label className="field">
                    ...
                    <select
                        ...
                        onChange={(event) => selectDistributedRun(event.target.value)}
                    >
                ...
                <label className="field distributed-artifact-import-field">
                    ...
                    <input
                        ...
                        disabled={Boolean(distributedBusy)}
                        onChange={(event) => void handleDistributedArtifactFiles(event)}
                    />
                    <small>
            ...
            {!selectedDistributedRun && !distributedError && (
                <div className="empty-state">
                    No distributed run selected. Start a recipe on connected agents or refresh the control server.
                </div>
            )}
            {selectedDistributedRun && <DistributedRunSummary run={selectedDistributedRun} />}
            {selectedDistributedRun && (
            ...
            {selectedMonitor && <DistributedRunMonitorPanel monitor={selectedMonitor} />}
