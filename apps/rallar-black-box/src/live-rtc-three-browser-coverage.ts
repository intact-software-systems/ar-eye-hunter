...
export const LIVE_RTC_THREE_BROWSER_COVERAGE: readonly LiveRtcThreeBrowserCoverageCase[] = [
    ...
    },
    {
        ...
        area: 'delivery',
        intent:
            'Run every three-browser realtime sender/receiver direct pair plus every sender multicast and broadcast.',
        required: true,
        testFile: 'full-stack-live-rtc-three-browser-matrix.spec.ts',
    ...
    },
    {
        ...
        area: 'delivery',
        intent:
            'Run every three-browser messages.rtc sender/receiver direct pair plus every sender multicast and broadcast.',
        required: true,
        testFile: 'full-stack-live-rtc-three-browser-matrix.spec.ts',
        evidence: ['six direct pairs', 'three multicasts', 'three broadcasts']
    },
    ...
    },
    {
        ...
        area: 'negative',
        intent:
            'Probe not-yet-in-sync/NACK behavior with a high minSnapshotVersion and retain server/runtime evidence.',
        required: true,
        testFile: 'full-stack-live-rtc-three-browser-matrix.spec.ts',
    ...
    },
    {
        ...
        area: 'negative',
        intent:
            'Exercise explicit denied group/room operations once the provisioned environment exposes stable permission fixtures.',
        required: false,
