        ...
        schemas: {
            ...
            ControlFleetRunReport: {
                ...
                properties: {
                    ...
                    summary: {
                        type: 'object',
                        required: ['agents', 'regions', 'passed', 'failed', 'missing', 'flaky', 'stale', 'passRate', 'failureGroups'],
                        properties: {
                            agents: { type: 'integer' },
            ...
            ControlFleetAgentRunOutcome: {
                ...
                properties: {
                    ...
                    state: { type: 'string', enum: ['passed', 'failed', 'missing', 'running', 'cancelled', 'timed-out', 'unknown'] },
                    ok: { type: 'boolean' },
            ...
            ControlFleetRegionSummary: {
                type: 'object',
                required: ['region', 'agentCount', 'passed', 'failed', 'missing', 'flaky', 'stale', 'passRate', 'timing'],
                properties: {
                    region: { type: 'string' },
                    provider: { type: 'string' },
                    agentCount: { type: 'integer' },
            ...
            ControlFleetFailureSignature: {
                ...
                properties: {
                    ...
                    category: { type: 'string', enum: ['targeting', 'readiness', 'barrier', 'command', 'diagnostic', 'runtime', 'unknown'] },
                    title: { type: 'string' },
            ...
            ControlFleetReportBundle: {
                ...
                properties: {
                    ...
                    files: {
                        type: 'object',
                        required: ['fleet-report.json', 'summary.md', 'agent-results.csv', 'failure-signatures.csv'],
                        properties: {
