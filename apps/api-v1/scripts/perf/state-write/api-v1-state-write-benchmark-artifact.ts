    ...
    return {
        ...
        measurement: {
            ...
            counterSources: {
                ...
                serializedResultBytes: 'JSON byte length of values returned by the thin postgres.js wrapper',
                ...
                computeTiming: 'production timing-sink events explicitly labeled phase=compute; zero when unavailable',
                validateTiming:
                ...
                outboxTiming: 'direct APP_OUTBOX/WS_OUTBOX resource_inbox SQL through the postgres.js wrapper',
                outbox: 'resource_inbox',
                attempts: 'resource_inbox.release.telemetry+app_inbox.ri_attempts reconciliation',
                receipts: 'complete production client/group/topology idempotency receipts ' +
