                ...
                async (transactionRepository) => {
                    ...
                    const group: Group = {
                        ...
                        emptySinceEpochMs: request.emptySinceEpochMs ??
                            existing.emptySinceEpochMs,
                        purgeAfterEpochMs: request.purgeAfterEpochMs ??
                            existing.purgeAfterEpochMs,
                    };
            ...
            const result = await runtimeRepository.begin(
                async (transactionRepository) => {
                    ...
                    const member: GroupMember = {
                        ...
                        invitedByPrincipalId: request.invitedByPrincipalId ??
