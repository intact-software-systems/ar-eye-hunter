...
interface ApiRtcTopologyAdminMetricsInput<TPlanningMetrics extends object, TReplayMetrics extends object> {
    readonly planning: RtcTopologyMetricsOwner<TPlanningMetrics>;
    readonly replay: RtcTopologyMetricsOwner<TReplayMetrics>;
}

export function createApiRtcTopologyAdminMetrics<TPlanningMetrics extends object, TReplayMetrics extends object>(
    input: ApiRtcTopologyAdminMetricsInput<TPlanningMetrics, TReplayMetrics>
): Readonly<{
