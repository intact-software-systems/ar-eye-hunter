import type { ClientStateSnapshotReadOptions, GroupStateSnapshotReadOptions } from '@shared/api/state-snapshot-read.ts';
...
export function readGroupSnapshotPointQuery(
    ...
    if (groupValues.length === 0 && presenceValues.length === 0) {
        return {};
    }
