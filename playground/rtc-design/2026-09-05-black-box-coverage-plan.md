...
| ID | Decision                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| -- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D1 | **No runner work is required.** Verified against the runner: `ws.wait` already matches on `expect.message.payload`, `route`, `targets` and `id`, supports `consume`, and captures variables that a later `assert` step compares. The gaps are authoring gaps, not capability gaps. Any slice that discovers otherwise must stop and re-plan rather than widening the runner opportunistically.                                                                                                                              |
