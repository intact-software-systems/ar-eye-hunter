...
| ICE config              | [`readIceCandidates`](../../packages/shared-web/browser/api-integration.ts#L589), [`iceRoute`](../../apps/api-v1/src/routes/ice-route.ts#L42), [`getMeteredIceCandidates`](../../apps/api-v1/src/services/get-metered-ice-candidates.ts#L3)                                                                                                                           | Reads browser ICE servers and fetches Metered TURN/STUN credentials when configured.                                  |
...
2. Proven from code: the browser obtains ICE candidates through
   ...
   [`getMeteredIceCandidates`](../../apps/api-v1/src/services/get-metered-ice-candidates.ts#L3).
