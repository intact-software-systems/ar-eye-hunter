...
import { compareCandidates, isTestPath, scanSources } from './test-structure-coupling-source-analysis.mjs';
...
function readChangeCandidates({ reviewInput, change }) {
    const previousResult = isTestPath(change.source)
        ...
        : emptyScan();
    const currentResult = change.target && isTestPath(change.target)
