...
entry. It decodes the six lifecycle commands and routes them directly to
...
- [plan-adaptation-lifecycle.mjs#completeAdaptivePlanSlice](./plan-adaptation-lifecycle.mjs#completeAdaptivePlanSlice)
  owns command side effects: plan writes, ignored drafts, read-only checks, final-evidence
  validation, and tactical-plan close-out.
