...
import { computeAdaptivePlanRecordDigest, parseAdaptivePlanRecord } from './adaptive-plan-record.mjs';
...
export function readAuthenticatedPlanClosureChanges(closureInput) {
    ...
    const changedReceipts = closureInput.changes.filter((change) => isPlanClosureReceiptPath(change.path));
