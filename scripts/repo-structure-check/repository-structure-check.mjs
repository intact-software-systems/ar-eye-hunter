    ...
    for (const [directory, descendants] of targetDirectories) {
        ...
        if (
            ...
            const finding = {
                ...
                message: `${baseDirectories.has(directory) ? 'Materially changed' : 'New'} authored-code ` +
    ...
    for (const [directory, descendants] of targetDirectories) {
        ...
        if (
            ...
            findings.push({
                ...
                message: 'Authored code passes through a directory with one code-bearing child and no direct ' +
                    'code responsibility.'
            });
        }
    }
