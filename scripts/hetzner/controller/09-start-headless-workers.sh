...
RALLAR_PLAYWRIGHT_ROOT="${RALLAR_PLAYWRIGHT_ROOT:-/var/lib/rallar-playwright}"
PLAYWRIGHT_BROWSERS_PATH="${PLAYWRIGHT_BROWSERS_PATH:-${RALLAR_PLAYWRIGHT_ROOT}/active}"
...
validate_worker_env() {
	...
	validate_required_value PLAYWRIGHT_BROWSERS_PATH
