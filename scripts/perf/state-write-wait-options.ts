...
import type { AppInboxServiceOptions } from
...
const waitMaxElapsedMsecs =
  maximumRetryDelayMs + STATE_WRITE_BENCHMARK_APP_INBOX_PROCESSING_MARGIN_MS;
...
export const STATE_WRITE_BENCHMARK_APP_INBOX_OPTIONS = {
  ...
  Record<'client' | 'group', AppInboxServiceOptions>
>;
