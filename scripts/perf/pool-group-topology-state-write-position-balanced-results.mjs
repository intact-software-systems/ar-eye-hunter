...
export const GROUP_TOPOLOGY_CONFLICT_REASON_SCHEMA = 'rallar.group-topology.state-write-conflict-reasons.v1';
export const GROUP_TOPOLOGY_PERFORMANCE_BASE_COMMIT = '39ad65b499c4bf944acfe48446ad1c334d97d37d';
...
const POSITION_BALANCED_PROTOCOL = 'rallar.group-topology.state-write-position-balanced-abba-baab.v1';
...
function createOuterManifest({ input, sources, blocks }) {
    return {
        ...
        positions: sources.map((source) => ({
            ...
            gitTree: source.role === 'approved-base'
