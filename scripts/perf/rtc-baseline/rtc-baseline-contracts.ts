...
export type RtcBaselineWorkloadId =
  'RTC-B01' | 'RTC-B02' | 'RTC-B03' | 'RTC-B04' | 'RTC-B05' | 'RTC-B06';
export type RtcBaselineEnvironmentId =
  'E1-local' | 'E2-browser' | 'E3-memory' | 'E4-pg' | 'E5-remote';
...
export type RtcBaselineFailureOwner =
  RtcBaselineSampleFailureOwner | { kind: 'cohort'; identity: RtcBaselineCohortIdentityDto };
export type RtcBaselineFailureOutcomeArtifact =
...
export type RtcBaselineFailureOutcomeDecodingResult =
