...
import * as TestFakes from '../../../packages/tests/shared-server/fake-runtime-state-repository.ts';
...
export interface RtcRttRepositoryFilterDependencies {
  readonly runtimeRepository: TestFakes.FakeRuntimeStateRepository;
...
function createDependencies(): RtcRttRepositoryFilterDependencies {
  return {
    runtimeRepository: new TestFakes.FakeRuntimeStateRepository(),
