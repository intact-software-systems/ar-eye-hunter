...
export function scanCognitiveMetricFindings(source) {
    ...
    if (metrics.valueExportCount >= valueExportLimit) {
        findings.push({
            ...
            message: `File exports ${metrics.valueExportCount} runtime values ` +
...
function visitIfStatement(walk, node, frame) {
    ...
    const isElseIf = parent !== undefined &&
...
function computeValueExportCount(sourceFile) {
    ...
    for (const statement of sourceFile.getStatements()) {
        ...
        const hasExport = typeof statement.hasExportKeyword === 'function' && statement.hasExportKeyword();
