...
export type RallarGameRuntimeRelay<TIntent, TSnapshot, TEvent> =
    RallarDirectorRelayHandle<
...
export type RallarGameCapabilityMessage =
    RallarMessage<RallarGameEnvelope<RallarGameHostCapability>>;
