...
export type { RallarMessageSelector, RallarMessageSelectorInput } from '@shared-web/browser/rallar-message-selectors.ts';
...
export type RallarFacade = RallarConnectionFacade & Readonly<{
    ...
    ws: Readonly<{
        ...
        onStatus(listener: RallarWsStatusListener, options?: RallarWsStatusSubscriptionOptions): import('@shared-web/browser/rallar-shared-contracts.ts').RallarUnsubscribe;
        onLifecycle(listener: RallarWsLifecycleListener, options?: RallarWsStatusSubscriptionOptions): import('@shared-web/browser/rallar-shared-contracts.ts').RallarUnsubscribe;
