...
export const RALLAR_CRDT_APPEND_REQUEST_TYPE_ID = 'rallar.crdt.append-request.v1';
export const RALLAR_CRDT_APPEND_RESPONSE_TYPE_ID = 'rallar.crdt.append-response.v1';
export const RALLAR_CRDT_CATCH_UP_REQUEST_TYPE_ID = 'rallar.crdt.catch-up-request.v1';
export const RALLAR_CRDT_CATCH_UP_RESPONSE_TYPE_ID = 'rallar.crdt.catch-up-response.v1';
...
export type RallarCrdtDurableUpdateRecord<TPayload = RallarCrdtOperationBatch> = Readonly<{
    document: RallarCrdtDocumentRef;
    documentKey: string;
...
export type RallarCrdtAppendAccepted<TPayload = RallarCrdtOperationBatch> = Readonly<{
    status: 'accepted';
    update: RallarCrdtUpdateEnvelope<TPayload>;
    append: RallarCrdtTrustedAppendMetadata;
...
export type RallarCrdtAppendDuplicate<TPayload = RallarCrdtOperationBatch> = Readonly<{
    status: 'duplicate';
    update: RallarCrdtUpdateEnvelope<TPayload>;
    append: RallarCrdtTrustedAppendMetadata;
    document: RallarCrdtDocumentMetadata;
...
export type RallarCrdtAppendRejected<TPayload = RallarCrdtOperationBatch> =
    | RallarCrdtAppendRejectedBase<TPayload>
        & Readonly<{
...
export type RallarCrdtAppendBatchInput<TPayload = RallarCrdtOperationBatch> = Readonly<{
    document: RallarCrdtDocumentRef;
    updates: readonly RallarCrdtAppendUpdateInput<TPayload>[];
    stopOnFirstRejection?: boolean;
}>;

export type RallarCrdtAppendBatchResult<TPayload = RallarCrdtOperationBatch> = Readonly<{
...
export type RallarCrdtUpdatePage<TPayload = RallarCrdtOperationBatch> = Readonly<{
    document: RallarCrdtDocumentRef;
...
export type RallarCrdtAppendRequestEnvelope<TPayload = RallarCrdtOperationBatch> = Readonly<{
...
export type RallarCrdtAppendResponseEnvelope<TPayload = RallarCrdtOperationBatch> = Readonly<{
    protocolVersion: RallarCrdtProtocolVersion;
    requestId: string;
    document: RallarCrdtDocumentRef;
    acceptedAtEpochMs: number;
...
export type RallarCrdtCatchUpResponseEnvelope<TValue = unknown, TPayload = RallarCrdtOperationBatch> = Readonly<{
    protocolVersion: RallarCrdtProtocolVersion;
    requestId: string;
    document: RallarCrdtDocumentRef;
    createdAtEpochMs: number;
...
export type RallarCrdtProjectionHooks<TPayload = RallarCrdtOperationBatch> = Readonly<{
    onAppendAccepted?: (
...
export type RallarCrdtUpdateLogRepository<TPayload = RallarCrdtOperationBatch, TValue = unknown> = Readonly<{
    append(
