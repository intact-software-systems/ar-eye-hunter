...
export class DequeueResourceEntryController {
    ...
    private static readonly RETRY_EXPONENTIAL_BACKOFF_STEPS: TimeUnit | undefined = "seconds";
    private static readonly FAILED_EXPONENTIAL_BACKOFF_STEPS: TimeUnit | undefined = "hours";

    // -------------------------
    // Java record ResilienceDto
    // -------------------------
    static ResilienceDto = class ResilienceDto {
        ...
        constructor(
            ...
            public readonly checkReserveTimeouts: InstanceType<typeof DequeueResourceEntryController.ResilienceDto.StatusChecker>,
            public readonly checkFailed: InstanceType<typeof DequeueResourceEntryController.ResilienceDto.StatusChecker>,
        ...
        static StatusChecker = class StatusChecker {
            ...
            static toReserveEntryTimeoutChecker(): InstanceType<typeof DequeueResourceEntryController.ResilienceDto.StatusChecker> {
                return new DequeueResourceEntryController.ResilienceDto.StatusChecker(
                    RateLimiter.init(
                        DequeueResourceEntryController.ResilienceDto.RATE_LIMITER_RESERVED_TIMEOUT_SLIDING_WINDOW_DURATION_MS,
                        DequeueResourceEntryController.ResilienceDto.MAX_NUM_IS_ENTRY_CHECK,
                    ),
                    RateLimiter.init(
                        DequeueResourceEntryController.ResilienceDto.RATE_LIMITER_RESERVED_TIMEOUT_SLIDING_WINDOW_DURATION_MS,
                        DequeueResourceEntryController.ResilienceDto.MAX_NUM_DEQUEUE_IN_WINDOW,
                    ),
                );
            }

            static toFailedEntryChecker(): InstanceType<typeof DequeueResourceEntryController.ResilienceDto.StatusChecker> {
                return new DequeueResourceEntryController.ResilienceDto.StatusChecker(
                    RateLimiter.init(
                        DequeueResourceEntryController.ResilienceDto.RATE_LIMITER_FAILED_CHECK_SLIDING_WINDOW_DURATION_MS,
                        DequeueResourceEntryController.ResilienceDto.MAX_NUM_IS_ENTRY_CHECK,
                    ),
                    RateLimiter.init(
                        DequeueResourceEntryController.ResilienceDto.RATE_LIMITER_FAILED_CHECK_SLIDING_WINDOW_DURATION_MS,
        ...
        ): InstanceType<typeof DequeueResourceEntryController.ResilienceDto> {
            const policy = RateAdjuster.toPolicy(
                initialRate,
                maxRate,
                concurrencyIncreaseStep,
                concurrencyReduceStep,
                DequeueResourceEntryController.ResilienceDto.MIN_CONSECUTIVE_SUCCESSES,
                DequeueResourceEntryController.ResilienceDto.RATE_ADJUST_WINDOW_MS,
            );

            return new DequeueResourceEntryController.ResilienceDto(
                CircuitBreaker.create(circuitBreakerPolicy),
                DequeueResourceEntryController.ResilienceDto.StatusChecker.toReserveEntryTimeoutChecker(),
                DequeueResourceEntryController.ResilienceDto.StatusChecker.toFailedEntryChecker(),
    ...
    public static toDequeuer<V>(
        ...
        resilience: InstanceType<typeof DequeueResourceEntryController.ResilienceDto>
        ...
        return DequeueController
            ...
            .onNewEntriesReserveDo((types, maxNumToReserve) =>
            ...
            .onRetryEntriesReserveDo((types, maxNumToReserve) =>
                dequeueResourceEntryRepository.reserveEntries(
                    types,
            ...
            .onFailedEntriesReserveDo((types, maxNumToReserve) =>
            ...
            .onTimeoutEntriesReserveDo((types, maxNumToReserve) => {
                const reservedTimeoutEntries = RateLimiter.tryToExecuteOrDefault(
            ...
            .onReleaseEntriesDo(
                // successReleaser
                (successByKey) => {
                    const released = dequeueResourceEntryRepository.releaseEntries(
