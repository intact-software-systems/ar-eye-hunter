...
export type AdminMetricsResetCategory = (typeof ADMIN_METRICS_RESET_CATEGORIES)[number];

export type AdminPruneExpiredCategory = (typeof ADMIN_PRUNE_EXPIRED_CATEGORIES)[number];

export type AdminOperationResultStatus = (typeof ADMIN_OPERATION_RESULT_STATUSES)[number];
...
export type AdminOperationsOverviewResponse = AdminOperationBaseResponse &
  Readonly<{
    health: Readonly<{
...
export type AdminOperationsQueuesResponse = AdminOperationBaseResponse &
  Readonly<{
    queueRows: Readonly<{
      total: number;
      expired: number;
...
export type AdminOperationsRealtimeResponse = AdminOperationBaseResponse &
  Readonly<{
    websocket: Readonly<{
      connectionCount: number;
      openConnectionCount: number;
...
export type AdminOperationsStateResponse = AdminOperationBaseResponse &
  Readonly<{
    clients: Readonly<{
...
export type AdminOperationsCrdtResponse = AdminOperationBaseResponse &
  Readonly<{
    documents: Readonly<{
      total: number;
...
export type AdminOperationsSystemResponse = AdminOperationBaseResponse &
  Readonly<{
...
export type AdminOperationResultResponse = AdminOperationBaseResponse &
  Readonly<{
    operation: string;
