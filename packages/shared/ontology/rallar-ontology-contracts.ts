export type RallarOntologyIri = `https://github.com/intact-software-systems/ar-eye-hunter/ontology/${string}`;
...
export type RallarOntologyTermId = `https://github.com/intact-software-systems/ar-eye-hunter/ontology/term/${string}`;
export type RallarOntologyOwnerId = `https://github.com/intact-software-systems/ar-eye-hunter/ontology/owner/${string}`;
...
export const RALLAR_RELATION_IDS = {
    ...
    identifies: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/identifies',
    projects: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/projects',
    identifiedBy: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/identified-by',
    sessionOf: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/session-of',
    runsOn: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/runs-on',
    mayCarryScope: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/may-carry-scope',
    usesGroupRef: 'https://github.com/intact-software-systems/ar-eye-hunter/ontology/relation/uses-group-ref'
...
export interface RallarOntologyVocabularyModule<TTerm extends RallarOntologyTermBase = RallarOntologyTermBase> {
