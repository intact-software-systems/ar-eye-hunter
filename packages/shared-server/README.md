...
| ------------------------ | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| AppInbox                 | `rallar-system/app-inbox/app-inbox-queue-client.ts`, `app-inbox-handler-registry.ts` | Reservation, typed result, retry/failure, transaction finalization      | `packages/tests/shared-server/rallar-system/app-inbox/`                   |
