...
export interface ComputeAcceptedInMemoryCrdtAppendInput<TPayload extends RallarCrdtOperationBatch, TValue> {
...
export function computeAcceptedInMemoryCrdtAppend<TPayload extends RallarCrdtOperationBatch, TValue>(
    ...
    const nextState: InMemoryCrdtDocumentState<TPayload, TValue> = {
        ...
        metadata: {
            ...
            storedUpdateBytes: input.decision.state.metadata.storedUpdateBytes + input.decision.updateBytes
        },
        records
    };
