...
export type CrdtCanonicalSnapshotEnvelope = Omit<RallarCrdtSnapshotEnvelope, 'metadata'> &
  Readonly<{
...
type CreateCrdtMutationCommandVariant<T> = Omit<
  T,
  'version' | 'commandHash' | 'documentKey' | 'deliveryId'
> &
  Readonly<{ deliveryId?: string }>;

type CreateCrdtSnapshotCompactCommandInput = Omit<
