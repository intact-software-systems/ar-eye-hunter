...
export class GroupTopologyConfigRepository extends RuntimeStateJsonStore {
    ...
    async readMutationExactEntries(
        ...
        return await readGroupTopologyMutationExactEntries(
            ...
            createGroupTopologyMutationExactReadLocations(this, {
            ...
            createGroupTopologyMutationExactReadDecoders(ref, requestId, {
                validateSourceRaw: assertCanonicalTopologySourceEntry,
                decodeConfigLive: (stored, trustedRef) =>
                    toValidatedLiveTopologySourceEntry(
                ...
                validateInvariantRaw: decodeTopologyInvariantEntry,
                validateInvariantLive: decodeTopologyInvariantValue,
                validateGenerationRaw: decodeTopologyGenerationEntry,
                validateGenerationLive: decodeTopologyGenerationValue,
                validateMutationRaw: decodeTopologyMutationEntry,
                validateMutationLive: decodeTopologyMutationValue,
                assertRetained: assertRetainedTopologyEntry,
            }),
        );
    }
...
function decodeTopologyGenerationValue(
    ...
    const generation = validateTopologyBoundary(entry.key, () =>
        configBoundary.readTopologyConfigGenerationBoundary(
            value,
            decoded,
            decoded.target,
        )
