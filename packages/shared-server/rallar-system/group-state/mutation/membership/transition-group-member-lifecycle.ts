import type { AuditStamp, GroupEventType, GroupMember, GroupMemberStatus } from '@shared/api/group-types.ts';
...
type GroupMemberLifecycleInput =
    & Omit<GroupMember, 'status' | 'left' | 'removed' | 'banned'>
    & Readonly<{
