...
export class GroupPresenceSummaryWork {
    ...
    constructor(options: GroupPresenceSummaryWorkOptions) {
        ...
        this.coalescedTopologyWorkService = options.topologyIntent.damping === 'damped'
    ...
    compute(
        ...
        const snapshot = assembleGroupStateSnapshot(
            {
                ...
                sessionLeaseFields: this.options.topologyIntent.damping === 'damped'
                    ? 'authoritative'
                    : 'summary-frozen'
            },
        ...
        return {
            ...
            coalescedTopologyWork: intent.damping === 'damped'
                ? computeCoalescedRtcTopologyGroupRevisionWork({
...
export function computeGroupPresenceSummaryOutboxEntries(
    ...
    const snapshotEntries = input.disseminationMode === 'delta-primary' ? [] : computeGroupSnapshotSyncEntries(input);
