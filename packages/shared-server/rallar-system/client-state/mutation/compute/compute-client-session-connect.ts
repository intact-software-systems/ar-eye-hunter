...
type ConnectCommand = Extract<ClientMutationCommand, { operation: 'connectSession' | 'connectAuthorisedWsSession'; }>;
...
function compareGenerationTuple(
    ...
    if (input.leftGenerationId === input.rightGenerationId) {
        return 0;
    }
