...
export interface ClientRestSnapshotReadRequest extends ClientStateSnapshotReadOptions {
...
class ClientRestSnapshotReadSelectorOwner implements ClientRestSnapshotReadSelector {
