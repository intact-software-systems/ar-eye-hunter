...
export abstract class ClientStateRepositoryReads extends ClientStateSnapshotRepository {
  ...
  protected toInstanceEntry(
    ...
    return withClientStateRepositoryInvariantError(stored.entry.key, () => {
      ...
      if (expected) assertExpectedClientStorageIdentity(keyRef, expected, 'instance');
  ...
  protected toSessionEntry(
    ...
    return withClientStateRepositoryInvariantError(stored.entry.key, () => {
      ...
      if (expected) assertExpectedClientStorageIdentity(keyRef, expected, 'session');
...
export function normalizePersistedClientEventForRepository(
  ...
  return withClientStateRepositoryInvariantError(clientStatePrincipalStorageKey(expected), () =>
