...
export function validateClientPrincipal(
  ...
  if (principal.disabled !== null) validateClientAudit(principal.disabled, `${label}.disabled`);
  if (principal.deleted !== null) validateClientAudit(principal.deleted, `${label}.deleted`);
...
export function validateClientInstance(
  ...
  if (instance.revoked !== null) validateClientAudit(instance.revoked, `${label}.revoked`);
