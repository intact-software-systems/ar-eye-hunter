...
export type LocalRtcTopologyClusterBus = Readonly<{
    listenersByChannel: Map<string, Set<(notification: RtcTopologyPublicationNotification) => void | Promise<void>>>;
}>;
...
export function isRtcTopologyPublicationNotification(
    ...
    const commonFieldsAreValid = typeof notification.publisherId === 'string' &&
