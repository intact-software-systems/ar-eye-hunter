...
export function sameClientPrincipalState(
    left: ClientPrincipal,
    right: ClientPrincipal,
): boolean {
...
export function sameClientInstanceState(
    left: ClientInstance,
    right: ClientInstance,
): boolean {
...
export function sameClientSessionState(
    left: ClientSession,
    right: ClientSession,
): boolean {
...
function jsonEquals(left: unknown, right: unknown): boolean {
    ...
    if (!isClientJsonObject(left) || !isClientJsonObject(right)) return false;
...
export function isClientJsonObject(
    value: unknown,
