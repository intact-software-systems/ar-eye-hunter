...
export type TopologyAppInboxCommand = TopologyAppInboxCommandByOperation[TopologyAppInboxCommandOperation];

type CreateTopologyAppInboxCommandInputFor<Operation extends TopologyAppInboxCommandOperation> = Readonly<{
...
export type TopologyAppInboxAuthority = TopologyConfigAppInboxAuthority | TopologyReconfigureAppInboxAuthority;
