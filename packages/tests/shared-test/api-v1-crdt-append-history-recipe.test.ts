...
const recipePath = 'packages/shared-test/black-box-runner/tests/api-v1/api-v1-crdt-append-history.json';
...
describe('API-v1 CRDT append-history black-box evidence', () => {
    it('registers one parameterized recipe at the three bounded history scales', () => {
        const entries = readApiV1Matrix().entries.filter((entry) => entry.profiles.includes('api-v1-black-box-crdt-append-history'));
