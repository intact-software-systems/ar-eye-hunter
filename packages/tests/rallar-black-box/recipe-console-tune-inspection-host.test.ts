...
import { TuneInspector } from
    '../../../apps/rallar-black-box/src/recipe-console/tune/TuneInspector.tsx';
import type { TuneInspection } from
    '../../../apps/rallar-black-box/src/recipe-console/tune/tune-inspection.ts';
import type { TuneSourceModel } from
    '../../../apps/rallar-black-box/src/recipe-console/tune/tune-source-model.ts';
import { useTuneInspectionHost } from
    '../../../apps/rallar-black-box/src/recipe-console/tune/use-tune-inspection-host.tsx';
...
describe('useTuneInspectionHost', () => {
    ...
    it('synchronizes scoped inspector content and clears it across authority changes and unmount', async () => {
        ...
        if (!isValidElement<{
            selection: TuneInspection;
            source: TuneSourceModel;
        }>(contentA)) throw new Error('Expected TuneInspector content.');
