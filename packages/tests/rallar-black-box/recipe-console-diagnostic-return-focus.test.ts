...
} from '../../../apps/rallar-black-box/src/recipe-console/routing/diagnostic-return-focus.ts';

const RECIPE_CONSOLE_URL =
    'http://127.0.0.1:5176/?v=1&experience=recipe-console&view=monitor';
