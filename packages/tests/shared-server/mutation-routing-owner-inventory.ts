...
HTTP\tPOST ${GROUP_ITEM_ROUTE}/lifecycle/establish\tGROUP_ESTABLISHMENT_START\tgs\tregisterStartGroupEstablishmentRoute\tgc\tAppInboxType.GROUP_ESTABLISHMENT_START\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tstart-group-establishment\tregisterGroupStateMutationRoutes\tgr\tregisterGroupStateRoutes\t3
HTTP\tPOST ${GROUP_ITEM_ROUTE}/lifecycle/activate\tGROUP_ACTIVATE\tgs\tregisterActivateGroupRoute\tgc\tAppInboxType.GROUP_ACTIVATE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tactivate-group\tregisterGroupStateMutationRoutes\tgr\tregisterGroupStateRoutes\t3
HTTP\tPOST ${GROUP_ITEM_ROUTE}/lifecycle/reopen\tGROUP_ESTABLISHMENT_REOPEN\tgs\tregisterReopenGroupEstablishmentRoute\tgc\tAppInboxType.GROUP_ESTABLISHMENT_REOPEN\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\treopen-group-establishment\tregisterGroupStateMutationRoutes\tgr\tregisterGroupStateRoutes\t3
...
MAINTENANCE\tformation criterion evaluation\tGROUP_FORMATION_CRITERION\tci\tsubmitFormationCriterionCommand\tci\tenqueueFormationCriterionCommand\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG
...
WS_INBOX\ttopic rallar/crdt/update\tCRDT_UPDATE_APPEND\td\taccepted.kind === 'update'\td\tmutationIngress.enqueueUpdate\tD\tAppCrdtInboxService.processCommand
