...
HTTP\tPOST ${GROUP_ROUTE}\tGROUP_CREATE\tgs\tregisterCreateGroupRoute\tgc\tAppInboxType.GROUP_CREATE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tcreate-group\tregisterGroupStateMutationRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPUT ${GROUP_ITEM_ROUTE}\tGROUP_UPDATE\tgs\tregisterUpdateGroupRoute\tgc\tAppInboxType.GROUP_UPDATE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tupdate-group\tregisterGroupStateMutationRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/director/appoint\tGROUP_DIRECTOR_APPOINT\tgs\tregisterAppointGroupDirectorRoute\tgc\tAppInboxType.GROUP_DIRECTOR_APPOINT\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tappoint-group-director\tregisterGroupStateMutationRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/join\tGROUP_JOIN\tga\tregisterJoinGroupRoute\tgc\tAppInboxType.GROUP_JOIN\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tjoin-group\tregisterGroupAdmissionRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/invites/:principalId\tGROUP_INVITE_CREATE\tga\tregisterCreateGroupInviteRoute\tgc\tAppInboxType.GROUP_INVITE_CREATE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tcreate-group-invite\tregisterGroupAdmissionRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/invites/:principalId/revoke\tGROUP_INVITE_REVOKE\tga\tregisterRevokeGroupInviteRoute\tgc\tAppInboxType.GROUP_INVITE_REVOKE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\trevoke-group-invite\tregisterGroupAdmissionRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/invites/accept\tGROUP_INVITE_ACCEPT\tga\tregisterAcceptGroupInviteRoute\tgc\tAppInboxType.GROUP_INVITE_ACCEPT\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\taccept-group-invite\tregisterGroupAdmissionRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/join-code/rotate\tGROUP_JOIN_CODE_ROTATE\tga\tregisterRotateGroupJoinCodeRoute\tgc\tAppInboxType.GROUP_JOIN_CODE_ROTATE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\trotate-group-join-code\tregisterGroupAdmissionRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/members/:principalId/remove\tGROUP_MEMBER_REMOVE\tgm\tregisterRemoveGroupMemberRoute\tgc\tAppInboxType.GROUP_MEMBER_REMOVE\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tremove-group-member\tregisterGroupMembershipRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/members/:principalId/ban\tGROUP_MEMBER_BAN\tgm\tregisterBanGroupMemberRoute\tgc\tAppInboxType.GROUP_MEMBER_BAN\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tban-group-member\tregisterGroupMembershipRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/members/:principalId/unban\tGROUP_MEMBER_UNBAN\tgm\tregisterUnbanGroupMemberRoute\tgc\tAppInboxType.GROUP_MEMBER_UNBAN\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tunban-group-member\tregisterGroupMembershipRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPUT ${GROUP_ITEM_ROUTE}/members/:principalId/role\tGROUP_MEMBER_ROLE_SET\tgm\tregisterSetGroupMemberRoleRoute\tgc\tAppInboxType.GROUP_MEMBER_ROLE_SET\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tset-group-member-role\tregisterGroupMembershipRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/owner/transfer\tGROUP_OWNERSHIP_TRANSFER\tgm\tregisterTransferGroupOwnershipRoute\tgc\tAppInboxType.GROUP_OWNERSHIP_TRANSFER\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\ttransfer-group-ownership\tregisterGroupMembershipRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPUT ${GROUP_ITEM_ROUTE}/members/:principalId\tGROUP_MEMBER_UPSERT\tgm\tregisterUpsertSelfGroupMemberRoute\tgc\tAppInboxType.GROUP_MEMBER_UPSERT\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tupsert-group-member\tregisterGroupMembershipRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPUT ${GROUP_ITEM_ROUTE}/sessions/:sessionId\tGROUP_PRESENCE_CONNECT\tgp\tregisterConnectGroupPresenceRoute\tgc\tAppInboxType.GROUP_PRESENCE_CONNECT\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tconnect-group-presence\tregisterGroupPresenceRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/sessions/:sessionId/heartbeat\tGROUP_PRESENCE_HEARTBEAT\tgp\tregisterHeartbeatGroupPresenceRoute\tgc\tAppInboxType.GROUP_PRESENCE_HEARTBEAT\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\theartbeat-group-presence\tregisterGroupPresenceRoutes\tgr\tregisterGroupStateRoutes
HTTP\tPOST ${GROUP_ITEM_ROUTE}/sessions/:sessionId/disconnect\tGROUP_PRESENCE_DISCONNECT\tgp\tregisterDisconnectGroupPresenceRoute\tgc\tAppInboxType.GROUP_PRESENCE_DISCONNECT\tH\tGroupStateInboxHandler.processGroupStateMutation\tI\tG\tdisconnect-group-presence\tregisterGroupPresenceRoutes\tgr\tregisterGroupStateRoutes
