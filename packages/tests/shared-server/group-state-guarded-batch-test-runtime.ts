...
export const BATCH_SELECTED = new Error('guarded group batch selected');

export class BeginOnlyGuardedBatchRepository extends FakeRuntimeStateRepository {
  batchCalls = 0;
...
export class CollidingGroupEventStore extends InMemoryGroupStateEventStore {
  constructor(private readonly runtime: ApplyingGuardedBatchRepository) {
    super();
  }
