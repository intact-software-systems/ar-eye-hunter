...
import type { RuntimeStateGuardedBatchComputed } from '@shared-server/runtime-state/guarded-batch/runtime-state-guarded-batch.ts';
...
class RejectingGuardedBatchRepository extends FakeRuntimeStateRepository {
    ...
    executeGuardedBatch(_batch: RuntimeStateGuardedBatchComputed): Promise<never> {
        this.batchCalls += 1;
