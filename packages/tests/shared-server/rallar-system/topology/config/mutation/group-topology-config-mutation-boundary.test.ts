...
describe('topology config mutation raw boundaries', () => {
  ...
  it('hands only exact named contracts to typed continuation validators', () => {
    ...
    expectTypeOf<
      ReturnType<typeof readTopologyConfigGenerationBoundary>
    >().toEqualTypeOf<GroupTopologyConfigGeneration>();
    expectTypeOf<
      ReturnType<typeof readTopologyConfigInvariantGenerationBoundary>
    >().toEqualTypeOf<GroupTopologyConfigInvariantGeneration>();
    expectTypeOf<
      ReturnType<typeof readStoredTopologyConfigBoundary>
    >().toEqualTypeOf<StoredGroupTopologyConfig>();
    expectTypeOf<
      ReturnType<typeof readStoredTopologyOverrideBoundary>
    >().toEqualTypeOf<StoredGroupTopologyOverride>();
    expectTypeOf<
      ReturnType<typeof readTopologyConfigMutationRecordBoundary>
    >().toEqualTypeOf<GroupTopologyConfigMutationRecord>();
    expectTypeOf<
      ReturnType<typeof readTopologyConfigReceiptBoundary>
    >().toEqualTypeOf<GroupTopologyConfigMutationReceipt>();
    expectTypeOf<
      Parameters<typeof validateGroupTopologyConfigGeneration>[0]
    >().toEqualTypeOf<GroupTopologyConfigGeneration>();
    expectTypeOf<
      Parameters<typeof validateGroupTopologyConfigInvariantGeneration>[0]
    >().toEqualTypeOf<GroupTopologyConfigInvariantGeneration>();
    expectTypeOf<
      Parameters<typeof validateStoredGroupTopologyConfig>[0]
    >().toEqualTypeOf<StoredGroupTopologyConfig>();
    expectTypeOf<
      Parameters<typeof validateStoredGroupTopologyOverride>[0]
    >().toEqualTypeOf<StoredGroupTopologyOverride>();
    expectTypeOf<
      Parameters<typeof validateGroupTopologyConfigMutationRecord>[0]
    >().toEqualTypeOf<GroupTopologyConfigMutationRecord>();
    expectTypeOf<
      Parameters<typeof validateTopologyConfigReceipt>[0]
    >().toEqualTypeOf<GroupTopologyConfigMutationReceipt>();
  });
});
...
function expectGenericBoundaryRecordsRejected(groupRef: GroupRef, requestId: string): void {
  ...
  expect(() =>
    readTopologyConfigMutationRecordBoundary(genericRecord, { groupRef, requestId }),
  ).toThrow('Topology config mutation record fields are invalid');
