...
describe('RallarRtcTopologyService public facade', () => {
    ...
    it.each([
        ...
        },
        {
            ...
            invoke: ({ service, group }: DispatchScenario) => service.planGroupTopologyAt(group, [], {}, 100),
        ...
        },
        {
            ...
            invoke: ({ service, group }: DispatchScenario) => service.observeCommittedTopologySnapshot(createSnapshot(group)),
