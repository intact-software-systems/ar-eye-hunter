...
import { mutationBoundaryLexicalValuesEqual, type LexicalValueResolution, type MutationBoundaryLexicalValues } from './mutation-boundary-lexical-values.ts';
...
import { evaluateStaticTruth, readExactStaticString, resolveStaticValues } from './mutation-static-semantics.ts';
