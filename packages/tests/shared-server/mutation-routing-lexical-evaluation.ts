...
import { UNKNOWN_REGISTRATION_TYPES, type RegistrationTypeCollection } from './mutation-routing-registration-predicate.ts';
...
export function isProvenGlobalBuiltin(
    ...
    if (
        ...
        return alternatives.every((candidate) => isProvenGlobalBuiltin(candidate, name, lexical, new Set(resolving)));
    }
    return false;
}
