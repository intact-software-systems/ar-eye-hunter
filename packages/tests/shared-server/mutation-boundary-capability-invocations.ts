import { readCallFamily, resolveArgumentSlot, resolveInvocationArguments, unwrapCallableParameter } from './mutation-boundary-call-arguments.ts';
import type { InvocationArgumentSlot } from './mutation-boundary-call-arguments.ts';
import { bindCallableResolution, callableArrayResolution, collectCallableTargets } from './mutation-boundary-callable-collections.ts';
import { discoverLocalCallables, indexCallableReferences } from './mutation-boundary-callable-definitions.ts';
import { appendInvocationAlias, canonicalStorageKey, unionStoredAliases, type CallableHeapAliasWrite } from './mutation-boundary-callable-heap.ts';
import {
...
import { isCapturedCallableWrite, projectCallableResolution, readCallablePatternWrites } from './mutation-boundary-callable-storage.ts';
import {
...
import { isCall, readPosition, walkExecution, walkReachableAst } from './mutation-boundary-execution-walk.ts';
