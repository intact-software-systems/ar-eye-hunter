...
function createCanonicalReservation(
  epochs: Readonly<{ createdAtEpochMs: number; expireAtEpochMs: number }> = {
  ...
  const work: GroupPresenceSummaryWorkData = {
    ...
    createdAtEpochMs: epochs.createdAtEpochMs,
    expireAtEpochMs: epochs.expireAtEpochMs,
    acceptedCausalRevision: {
      groupRevision: 4,
      presenceRevision: 3,
    },
    event: {
      ...
      occurredAtEpochMs: epochs.createdAtEpochMs,
