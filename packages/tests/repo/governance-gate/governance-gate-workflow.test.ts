...
describe('governance gate workflow', () => {
    ...
    it('binds every phase to the real owner-focused package command', () => {
        ...
        expect(packageJson.scripts).toMatchObject({
            ...
            'check:retained-legacy': 'node scripts/review-legacy.mjs origin/main HEAD --registry docs/production-legacy-exceptions.md'
        });
    });
            ...
            jobs: {
                ...
                'release-gate': {
                    ...
                    with: {
                        ...
                        changed_repo_style_base: '${{ contains(github.event.pull_request.labels.*.name, \'skip-changed-gates\')' +
