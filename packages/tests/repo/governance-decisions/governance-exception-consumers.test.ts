...
import { readGovernedTestCouplingRegistry, validateRegistry } from '../../../../scripts/test-structure-coupling-registry-report.mjs';
...
describe('governance exception consumer projections', () => {
    it('adds an exact test-coupling receipt through native registry validation', () => {
        ...
        const semanticCoverage = 'packages/tests/example/public.test.ts#keeps the public contract callable';
