...
import {
  ...
  runRtcBaselineCli,
} from '../../../scripts/perf/rtc-baseline/rtc-baseline-cli.ts';
import type { RtcBaselineEnvelope } from '../../../scripts/perf/rtc-baseline/rtc-baseline-envelope.ts';
...
describe('RTC baseline CLI application', () => {
  ...
  it('keeps default composition thin and import side-effect free when import.meta.main is false', async () => {
    ...
    try {
      const imported =
        await import('../../../scripts/perf/rtc-baseline/rtc-baseline-cli.ts?import-only');
