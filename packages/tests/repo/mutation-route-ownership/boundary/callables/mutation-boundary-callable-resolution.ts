import type { ExecutionBranch } from '../../execution/mutation-boundary-execution-walk.ts';
import { executionWriteScenarios } from '../../execution/mutation-execution-branches.ts';
import {
