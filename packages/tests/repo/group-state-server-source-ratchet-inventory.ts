...
export const taskSevenRepairProductionOwners = [
  ...
  'packages/shared-test/black-box-runner/api-v1-managed-api-readiness.mts',
  'packages/shared-test/black-box-runner/api-v1-managed-log-tail.mts',
  'packages/shared-test/black-box-runner/api-v1-managed-api-redaction-patterns.mts',
  'packages/shared-test/black-box-runner/api-v1-managed-postgres-run-database.mts',
  'packages/shared-test/black-box-runner/api-v1-managed-process-lifecycle.mts',
  'packages/shared-test/black-box-runner/api-v1-state-write-evidence-contracts.ts',
  'packages/shared-test/black-box-runner/api-v1-state-write-evidence-derivation.ts',
  'packages/shared-test/black-box-runner/api-v1-state-write-evidence-source.ts',
  'packages/shared-test/black-box-runner/api-v1-state-write-evidence-sql.ts',
