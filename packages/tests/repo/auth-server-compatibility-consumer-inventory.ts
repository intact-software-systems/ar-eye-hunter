...
export const authCompatibilityConsumerInventory = [
  ...
  },
  {
    ...
    consumers: [
      ...
      'apps/api-v1/test/db/pglite-runtime-transactions.test.ts',
      'apps/api-v1/test/db/pglite-state-event-pagination.test.ts',
      'apps/api-v1/test/db/pglite-state-event-validation.test.ts',
      'apps/api-v1/test/db/pglite-queue-and-crdt.test.ts',
      'apps/api-v1/test/db/pglite-sql-adapter-test-runtime.ts',
