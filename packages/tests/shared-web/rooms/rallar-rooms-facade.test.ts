...
import type { RallarReplayEventsResult, RallarStateListener, RallarUnsubscribe } from '@shared-web/browser/rallar-shared-contracts.ts';
        ...
        statement.type === 'ExportNamedDeclaration'
            ? statement.specifiers.flatMap((specifier) =>
                specifier.type === 'ExportSpecifier'
                    ? [
                        {
                            exportedName: 'name' in specifier.exported
...
it('retains the current public facade return types through the existing path', () => {
    ...
    expectTypeOf<RallarRoomsFacade['listEvents']>().returns.toEqualTypeOf<Promise<readonly GroupEvent[]>>();
    expectTypeOf<RallarRoomsFacade['listEventPage']>().returns.toEqualTypeOf<Promise<StateEventPage<GroupEvent>>>();
    expectTypeOf<RallarRoomsFacade['replayEvents']>().returns.toEqualTypeOf<Promise<RallarReplayEventsResult<GroupEvent>>>();
    expectTypeOf<RallarRoomsFacade['create']>().returns.toEqualTypeOf<Promise<GroupSnapshot>>();
    expectTypeOf<RallarRoomsFacade['createAndSwitch']>().returns.toEqualTypeOf<Promise<GroupSnapshot>>();
    ...
    expectTypeOf<RallarRoomsFacade['leave']>().returns.toEqualTypeOf<Promise<GroupSnapshot | undefined>>();
    expectTypeOf<RallarRoomsFacade['waitForPresence']>().returns.toEqualTypeOf<Promise<RallarRoomPresenceWaitResult>>();
