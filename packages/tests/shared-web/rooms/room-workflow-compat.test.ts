...
import type { CreateAndJoinStateGroupOptions, JoinStateGroupIntent, StateGroupWorkflowValue } from '@shared-web/browser/api-workflows.ts';
import type {
...
describe('room workflow path compatibility', () => {
    ...
    it('keeps every legacy positional function signature and return', () => {
        ...
        expectTypeOf(legacyWorkflows.removeStateGroupMember).toEqualTypeOf<GovernMemberWorkflow<RemoveStateGroupMemberBody>>();
        expectTypeOf(legacyWorkflows.banStateGroupMember).toEqualTypeOf<GovernMemberWorkflow<BanStateGroupMemberBody>>();
        expectTypeOf(legacyWorkflows.unbanStateGroupMember).toEqualTypeOf<GovernMemberWorkflow<UnbanStateGroupMemberBody>>();
