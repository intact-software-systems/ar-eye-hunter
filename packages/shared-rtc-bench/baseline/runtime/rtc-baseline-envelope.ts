...
export function createRtcBaselineEnvelope(dependencies: Dependencies): RtcBaselineEnvelope {
    return {
        ...
        recordExternalCohortAssertion: (input) => dependencies.acceptance.recordExternalCohortAssertion(input),
        ...
        readVerifiedRepeatPrimary: (input) => dependencies.finalizedReader.readVerifiedRepeatPrimary(input)
    };
}
