...
const sourcePaths = [
  ...
  'baseline/runtime/rtc-baseline-deno-acceptance.ts',
  'baseline/runtime/rtc-baseline-deno-adapters.ts',
  'baseline/runtime/rtc-baseline-deno-evidence.ts',
  'baseline/runtime/rtc-baseline-deno-finalization.ts',
  'baseline/runtime/rtc-baseline-deno-runtime.ts',
  'baseline/runtime/rtc-baseline-envelope.ts',
  'baseline/runtime/rtc-baseline-repeat-initializer.ts',
...
const owningTests = [
  ...
  'tests/baseline/runtime/rtc-performance-baseline-runtime-observation.test.ts',
