...
describe('RTC baseline statistics', () => {
        ...
        [
            [
                ...
                'f'.repeat(40),
                {
                    ...
                    message: 'Metric cohort mixes headCommit: 0123456789abcdef0123456789abcdef01234567 versus ffffffffffffffffffffffffffffffffffffffff.'
                }
            ],
            [
                'headTree',
                'e'.repeat(40),
                {
                    ...
                    code: 'mixed-grouping-field',
                    message: 'Metric cohort mixes headTree: abcdef0123456789abcdef0123456789abcdef01 versus eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.'
                }
            ],
            [
                'environmentId',
            ...
            [
                ...
                'innerRuns=6/cli',
                {
                    ...
                    code: 'mixed-grouping-field',
                    message: 'Metric cohort mixes configurationIdentity: innerRuns=5/default versus innerRuns=6/cli.'
                }
            ]
        ] as const
    )('rejects a cohort mixed by %s', (field, changed, expectedIssue) => {
        expect(
            partitionRtcBaselineMetricObservations([
    ...
    )('rejects paired comparison non-Git mismatch %s', (field, changed, expectedIssue) => {
        const candidate = {
            ...grouping,
            headCommit: '1111111111111111111111111111111111111111',
            headTree: '2222222222222222222222222222222222222222',
