...
import { rtcBaselineIssue, type RtcBaselineResult } from '../../../baseline/contracts/rtc-baseline-contracts.ts';
...
const sampleIds = Array.from(
    { length: 5 },
    (_value, index) => `rtc-b04-protocol-test-fixed-retained-002-${String(index + 1).padStart(3, '0')}`
);
