import type { RtcBaselineJson, RtcBaselineRuntimeObservationDto, RtcBaselineSampleDto } from '../../../baseline/contracts/rtc-baseline-contracts.ts';
import { computeRtcDataChannelBrowserSoakSample } from '../../../workloads/browser-lifecycle/rtc-data-channel-browser-soak-validation.ts';
...
function toProducerCommand() {
    const relativePath = 'artifacts/staging/rtc-b05-browser-data-channel-lifecycle-iterations-25-warmup-001.json';
    return {
        executable: 'node',
        arguments: [
            scriptPath,
