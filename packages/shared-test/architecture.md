...
| [Messaging controller](./black-box-runner/browser/rallar-browser-runtime/messaging/black-box-rallar-messaging-controller.ts), [delivery ledger](./black-box-runner/browser/rallar-browser-runtime/messaging/black-box-rallar-delivery-ledger.ts) and [command decoder](./black-box-runner/browser/rallar-browser-runtime/decode-black-box-rallar-command-input.ts)                                                                                                           | Decode routing options once and project real message handles; wait/cancel/receipts read each handle through the session delivery registry, so a handle it evicted reads `unobservable`. |
