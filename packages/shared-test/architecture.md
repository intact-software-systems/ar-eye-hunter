...
| [Connection runtime](./black-box-runner/browser/rallar-browser-runtime/black-box-rallar-connection-runtime.ts) and [lifecycle controller](./black-box-runner/browser/rallar-browser-runtime/lifecycle-controller.ts)                                                                                                                         | Serialize authentication/connect/close; generation changes cancel stale work and close drains owned effects.                                          |
...
| [Messaging controller](./black-box-runner/browser/rallar-browser-runtime/messaging-controller.ts) and [command decoder](./black-box-runner/browser/rallar-browser-runtime/decode-black-box-rallar-command-input.ts)                                                                                                                          | Decode routing options once and project real message handles; wait/cancel/receipts retain the canonical browser delivery lifecycle across reconnects. |
