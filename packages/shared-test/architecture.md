...
| Entry and owner                                                                                                                                                            | Result and failure boundary                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Browser control agent](./rallar-bb-test/browser-control-agent.ts)                                                                                                         | `createRallarBlackBoxBrowserControlAgent` composes a given control connection and recipe runtime into start/dispose plus observable snapshots; `createDefaultRallarBlackBoxBrowserControlAgent` builds both for the agent page.                                                                                                                                                                                                                                                                                                   |
...
| [Distributed run](./rallar-bb-test/distributed-run.ts) and [run contract](./rallar-bb-test/docs/distributed-run-contract.md)                                               | Manifest and run contracts only: [validation](./rallar-bb-test/distributed-run-validation.ts) decodes manifests and [target resolution](./rallar-bb-test/distributed/resolve-distributed-run-targets.ts) resolves agents, without sockets or browsers.                                                                                                                                                                                                                                                                            |
