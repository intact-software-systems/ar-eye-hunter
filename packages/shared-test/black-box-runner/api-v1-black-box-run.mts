...
import { parseApiV1BlackBoxArgs, type ApiV1BlackBoxOptions } from './parse-api-v1-black-box-options.mts';
import {
...
async function runManagedProofOrRecipeMatrix(
    ...
    if (!databaseUrl) {
        throw new Error('RTC topology replay proof requires DATABASE_URL.');
    }
