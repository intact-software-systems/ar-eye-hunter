...
export type CreateBlackBoxRallarDirectorControllerOptions = BlackBoxRallarGenerationPort &
    Readonly<{
        ...
        scopeOf(config: BlackBoxRallarConnectionConfig, input?: BlackBoxRallarSendInput): ResolvedBlackBoxRallarScope | undefined;
        ...
        emitError(config: BlackBoxRallarConnectionConfig | undefined, topic: string, error: unknown, data?: unknown): void;
    }>;

export type BlackBoxRallarDirectorController = BlackBoxRallarDirectorRuntime &
    Readonly<{
