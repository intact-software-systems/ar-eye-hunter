...
| deadline reached at the effect (`runDurableEffect:503-505`; the claim-time guard at `runOutboundClaim:459` ran before any row was read and had no message id, so it is deleted and the read path owns the decision — ruling R6) | runtime                                                                                          | `expired` with the message id from the effect's canonical message                                                                                                                                                                                                                                                                                                                                                                                               |
