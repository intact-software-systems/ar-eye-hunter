...
amendments. Structure/boundary Tasks 0 through 5 are implemented in draft PR
#53; Task 6 verification/publication and human merge remain pending, and the
alignment pass has not started.
...
| [Browser room/group-state translation child](rallar-room-group-state-translation-boundary-plan.md) | Defines the browser `room` to authoritative `group-state` translation boundary and consumer compatibility.                     | Approved at blob `37861202ce25c3cd5832663a5a3f6d7e2e4a0e4e`; structure Tasks 0–5 implemented in draft PR #53; Task 6 pending. |
...
| Browser child plan                     | in-progress    | Exact Git blob `37861202ce25c3cd5832663a5a3f6d7e2e4a0e4e` is approved with only its recorded narrow amendments. Structure Tasks 0–5 are implemented in draft PR #53; Task 6 and the alignment pass remain pending.                                                                                   |
| Pilot child plans drafted and executed | in-progress    | The browser structure pass is implemented through Task 5 but not yet published/merged; the server and API-v1 plans intentionally do not exist yet.                                                                                                                                                   |
