...
retained only as non-gating plan-only external evidence. Auth is `ledger-published`; the linked
group-topology child is drafted and unapproved.
...
| [Group-topology server structure child](rallar-group-topology-server-structure-plan.md)                     | Defines authoritative topology config protocol, mutation, persistence, AppInbox, query, reconfigure, tests, and durable navigation.      | Drafted and unapproved; implementation is not authorized.                         |
                                                ...
                                                -> client-state evidence ledger
                                                    -> auth server structure
                                                        -> later auth evidence ledger
                                                            -> group-topology server structure
                                                                -> later topology evidence ledger
...
#93, so auth is `ledger-published`. The group-topology server structure child is
drafted and unapproved; no implementation branch or goal exists.
...
The [group-topology server structure child](rallar-group-topology-server-structure-plan.md) is
the next bounded Wave 2 plan. It is drafted and unapproved, so it authorizes no implementation
goal, branch, production change, API-v1 reorganization, RTC/RTT work, or future evidence.
...
| Group-topology server child plan       | drafted and unapproved   | [Topology plan](rallar-group-topology-server-structure-plan.md) is drafted from exact main `c2cb79c020bceee7f67e6fbc364ba96ea0d6a530`. It defines four sequential behavior-neutral implementation PRs but authorizes none until exact blob approval and planning merge.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
