...
`30774354577` attempt 1 are complete. The separate five-plan server ledger and
API-v1 child remain gated.
...
| [Server group-state structure child](rallar-group-state-server-structure-plan.md)                           | Defines authoritative server group-state ownership, moves, AppInbox flow, persistence, presence, and mirrored tests.                     | PR #59 implementation, PR #61/#62 traceability QA, and PR #64/#65 hardening implementations are complete; separate ledger publication is pending. |
| [Server group-state traceability QA child](rallar-group-state-server-traceability-qa-plan.md)               | Defines post-PR #59 guidance/independent lineage governance and behavior-neutral runtime traceability corrections in two sequential PRs. | PR #61 and PR #62 are complete; the completed hardening successor leaves only the separate server-ledger publication pending.                     |
| [Server group-state traceability hardening child](rallar-group-state-server-traceability-hardening-plan.md) | Adds durable navigation/guidance, then behavior-neutral protocol, transaction-owner, timing, presence-decision, and naming corrections.  | PR #64 and PR #65 are complete; the separate five-plan server evidence-ledger publication remains pending.                                        |
| `plans/api-v1-group-state-route-structure-plan.md`                                                          | Will define API-v1 group-state routes, defaults, translation, composition, OpenAPI, and black-box compatibility.                         | Blocked and unstarted; draft only after the server ledger is `ledger-published`.                                                                  |
...
The remaining future API-v1 child path becomes a Markdown link in this document
and the master program when its file is created. Do not create an empty plan
stub solely to make a link resolve.
...
| Server traceability hardening child    | implementation complete  | [Hardening plan](rallar-group-state-server-traceability-hardening-plan.md) records complete PR #64 and PR #65 publication envelopes. Its separate ledger publication is pending under the non-circular contract.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Pilot child plans drafted and executed | in-progress              | Browser child is `ledger-published`; server structure, QA, and hardening implementations are complete; only their separate server-ledger publication is pending; API-v1 remains intentionally undrafted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
