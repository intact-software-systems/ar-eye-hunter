...
| [Group-topology evidence ledger](rallar-group-topology-evidence-ledger-plan.md)                             | Reconciles the closed topology implementation, immutable deviations, warnings, ratchets, compatibility, and validation evidence.         | Active from exact main `8ee348e2`; implementation is closed but the ledger is not yet published. |
                                                    ...
                                                    -> auth server structure
                                                        -> later auth evidence ledger
                                                            -> group-topology server structure (closed)
                                                                -> group-topology evidence ledger (active)
...
The separately authorized evidence ledger is active; it changes no code or
performance evidence and cannot mark the child `ledger-published` before its
own future external publication envelope exists.
...
is the active bounded Wave 2 record. The implementation plan is authentically
closed at exact main `8ee348e215a3e30d9b4959ce90369aea1b55b620` and remains
deleted historical evidence. This ledger authorizes only reciprocal planning
reconciliation; it authorizes no production change, API-v1 reorganization,
RTC/RTT work, performance command, or future publication fact.
...
| Group-topology evidence ledger         | active                   | [Evidence plan](rallar-group-topology-evidence-ledger-plan.md) starts from exact main `8ee348e215a3e30d9b4959ce90369aea1b55b620`. Its sole slice may update only the new plan, generated registry, and these two reciprocal program records; topology is not `ledger-published` before that future pull request is merged and externally reconciled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
