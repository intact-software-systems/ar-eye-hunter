...
is drafted and unapproved. Its two QA PRs now precede Task 10; the ledger and
API-v1 remain gated.
...
| [Server group-state traceability QA child](rallar-group-state-server-traceability-qa-plan.md)      | Defines post-PR #59 skills/review guidance and behavior-neutral code traceability corrections in two sequential PRs.           | Drafted and unapproved; implementation is forbidden until the exact plan blob is approved, its planning PR is merged, and the resulting workflow passes. |
...
- execute PR A guidance/test ownership first and stop for its human merge;
- require PR A's exact resulting-main workflow before creating PR B;
- execute only the behavior-neutral PR B scope;
...
| Server traceability QA child           | drafted/unapproved       | [QA plan](rallar-group-state-server-traceability-qa-plan.md) defines PR A guidance/test ownership and PR B behavior-neutral code traceability. Neither implementation PR is authorized.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
