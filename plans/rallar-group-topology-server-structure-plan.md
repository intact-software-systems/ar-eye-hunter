...
comparison base. Exact current-main merge parent
`cc98414867f22cc28f0137ef40a1887ab862f87d`, tree
`6c071954df939b7dea9ba59aa5116fe7922a6cab`, is being reconciled into the
validated pre-reconciliation PR B candidate. PR A's preserved failed
...
| PR B persistence           | concurrent-main reconciliation | Original comparison base `0b1fa13e07f7a8e4540d389cd5e25dfa95270da4`, tree `31671a750ec84577a9b94898c61cc49ec0c91c00`, contains PR A resulting main `cd69565936d881c960dbe151cfe48917a4a2e1bb` as an ancestor. Pre-reconciliation candidate `546f70deade1abe4f66b0262e5a9698a830527ea`, tree `2443467b0023ead540a5a4a1666f916b607deb1f`, completed semantic, ownership, type, unit, full CI, build, warning-only style, changed-style, Prettier, diff, isolated PostgreSQL, and Critical 0/Important 0 review gates. Its approved schema-v5 governed performance evidence remains immutable historical evidence. Exact current-main parent `cc98414867f22cc28f0137ef40a1887ab862f87d`, tree `6c071954df939b7dea9ba59aa5116fe7922a6cab`, adds durable RTC replay/reconnect behavior and changes the measured benchmark/runtime integration, so performance applicability is not carried forward. The PR B structural lineage and frozen test inventory now bind that parent while preserving identical predecessor blobs and semantic mappings. Final reconciled-tree gates, independent reviews, commit, and a separately approved replacement performance envelope remain pending; no benchmark or publication is authorized. |
