...
```text
mutation-contracts|packages/shared-server/rallar-system/services/client-state-mutations.ts|46-277,1838-1861|68b26e991e08225a8069d93e7bdd62e4869ddeda8020eaed28bffc6395058b96|packages/shared-server/rallar-system/client-state/mutation/client-mutation-contracts.ts|1|291|4e4ba0ee65d8bcab56b5553578fdc8cc905760b0ce1efd1957dadf6c756b2cf5|import-path, export modifiers, and contract-owner formatting; no inherited capacity|boundary.unknown:ClientMutationCommand.metadata|inherited and accepted for PR A
...
command-root-facts-authority-validation|packages/shared-server/rallar-system/services/client-state-mutations.ts|302-317,2484-2561|c5c0c359d23367e59d40ba9b4ffb9b83b670f2b681252adc36cba9158915ecfb|packages/shared-server/rallar-system/client-state/mutation/command-validation/validate-client-mutation-command.ts|1|116|ccb4585eec6e9f4ccdf1a8a89954bec45b7949473070f27a4f6b1e9bc6947749|direct lower-contract imports and private helper declarations; no inherited capacity|boundary.unknown:command-facts-authority-boundaries|inherited and accepted for PR A
operation-input-validation|packages/shared-server/rallar-system/services/client-state-mutations.ts|318-461,1862-1904,1957-2004,2173-2185,2198-2202|f919687b2047781a90d10afce4fb75952a9005fcdffd8ccc9c183ec896893939|packages/shared-server/rallar-system/client-state/mutation/command-validation/validate-client-mutation-operation-input.ts|1|319|76d3efd9cde433e17228dfcfb34ad9be429e94f9db2f8d75c1b4f244f73cc933|direct compatibility exports, type-only stage contract, and helper declarations; no inherited capacity|boundary.unknown:generation-and-timestamp-boundaries|inherited and accepted for PR A
request-validation|packages/shared-server/rallar-system/services/client-state-mutations.ts|464-610,1905-1907,1935-2004,2173-2175,2187-2196|670497b39193256b5aab5757c0b67dce7b3ad52ae9cda1e0f8452f23119fe4a1|packages/shared-server/rallar-system/client-state/mutation/command-validation/validate-client-mutation-request.ts|1|266|66347b1a1f6b0761eed27f2de7f660cb615664db510ef6e083ee540cb92e629b|operation dispatcher and direct lower-contract imports; no inherited capacity|boundary.unknown:raw-request-and-timestamp-boundaries|inherited and accepted for PR A
...
contract-validation|packages/shared-server/rallar-system/services/client-state-mutations.ts|2286-2298,2300-2352,2354-2387,2389-2456,2458-2470,2615-2641,2643-2665|a64cba7b899af9e3909c981a4b40ca527667e6e6d030120f2aec7e827b718257|packages/shared-server/rallar-system/client-state/client-state-contract-validation.ts|1|312|c18901a1ad40ec40e6a4ee0a449ae5582b3d489004910436b3affee621554123|export modifiers, shared lower-level naming, direct contract-owner imports, and helper splits; no inherited capacity|boundary.unknown:client-contract-validation-boundaries|inherited and accepted for PR A
...
compute-principal|packages/shared-server/rallar-system/services/client-state-mutations.ts|1114-1126,1560-1604|eb1d38a8131efb03d88f6a9d4ff54ca46b4a00a0e954d6335df50d73c7538b9b|packages/shared-server/rallar-system/client-state/mutation/compute/compute-client-principal-mutation.ts|1|70|3084b74f550249c52c10be8ebf6be03562a627f944fac6e9674682efc2ce42e0|direct shared-owner imports and named-input syntax; no inherited capacity|none|inherited and accepted for PR A
...
contracts moved from source lines `46-277`; the closed operation, entity, and
event inventories moved from lines `1838-1861` to the same lower contract owner.
...
Operation-specific command validation and its input-key inventories moved;
shared closed inventories are direct named compatibility exports from their
lower contract owner, while persisted-key inventories remain with the
transitional persistence owner.
...
lower-level contract owner and imports shared inventories directly from the
contract module. Receipt and idempotency regions are excluded.
