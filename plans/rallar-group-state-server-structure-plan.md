...
| write candidate, event, receipt, no-op, and rejection assembly plus idempotency-record, receipt, and command-hash validation | `group-mutation-result.ts`.                                                                                                                                                                                                                    |
...
validators in place; it does not move, merge, or re-own them.
