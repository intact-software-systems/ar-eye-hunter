...
> pending behavior-neutral Tasks 8–9 alignment in existing draft PR #59; Task 10 and
...
| Pure aggregate candidate construction and policy                                                                                    | `compute-group-aggregate-mutation.ts`, `create-initial-group-mutation.ts`, and `group-aggregate-mutation-policy.ts`                                                                                                       |
| Pure membership candidate construction, policy, writes, and lifecycle transitions                                                   | `compute-group-membership-mutation.ts`, `compute-group-membership-write.ts`, `group-membership-mutation-policy.ts`, and `transition-group-member-lifecycle.ts`                                                            |
| Pure presence candidate and admission construction                                                                                  | `compute-group-presence-mutation.ts` and `compute-group-presence-admission.ts`                                                                                                                                            |
| Exact mutation reads, command-slot identities, targets, and authority batches                                                       | `read-group-mutation.ts`, `read-group-mutation-related-entries.ts`, `resolve-group-mutation-read-identities.ts`, `resolve-group-mutation-target.ts`, and the two exact `persistence/read-*.ts` owners                     |
| Command, operation-input, read, computed-write, roster-fact, and result validation                                                  | the exact six `validate-*.ts` mutation owners named for those responsibilities; `validate-group-mutation.ts` retains orchestration                                                                                        |
...
| request, command, and operation-input validation in `group-state-mutations.ts`                                                 | `group-mutation-request-validation.ts`, `validate-group-mutation-command.ts`, and `validate-group-mutation-operation-input.ts`.                                                                                                                                                         |
| interim `mutation/group-mutation-command-validation.ts`                                                                        | Its command-validation family moves to `validate-group-mutation-command.ts` and its operation-input family moves to `validate-group-mutation-operation-input.ts`; remove the interim file without adding a compatibility path.                                                          |
| read assembly, related-entry reads, command-slot identity/target resolution, and read validation in `group-state-mutations.ts` | `read-group-mutation.ts`, `read-group-mutation-related-entries.ts`, `resolve-group-mutation-read-identities.ts`, `resolve-group-mutation-target.ts`, and `validate-group-mutation-read.ts`.                                                                                             |
...
| computed-candidate validation in `group-state-mutations.ts`                                                                    | `validate-computed-group-mutation.ts`, `validate-computed-group-mutation-write.ts`, and `validate-computed-roster-facts.ts`.                                                                                                                                                            |
| compute dispatcher and idempotency probe in `group-state-mutations.ts`                                                         | `compute-group-mutation.ts`.                                                                                                                                                                                                                                                            |
| create/update/director compute functions and aggregate policy                                                                  | `compute-group-aggregate-mutation.ts`, `create-initial-group-mutation.ts`, and `group-aggregate-mutation-policy.ts`.                                                                                                                                                                    |
| invite/member/ownership compute functions, policy, write assembly, and lifecycle transitions                                   | `compute-group-membership-mutation.ts`, `compute-group-membership-write.ts`, `group-membership-mutation-policy.ts`, and `transition-group-member-lifecycle.ts`.                                                                                                                         |
| connect/heartbeat/disconnect compute and admission functions                                                                   | `compute-group-presence-mutation.ts` and `compute-group-presence-admission.ts`.                                                                                                                                                                                                         |
| write candidate, event, receipt, no-op, and rejection assembly                                                                 | `group-mutation-result.ts`.                                                                                                                                                                                                                                                             |
| idempotency-record, receipt, and command-hash validation                                                                       | `validate-group-mutation-result.ts`.                                                                                                                                                                                                                                                    |
...
| `mutation/validate-group-mutation-command.ts`                  | `validateGroupMutationCommand`                                                                                                                               | exact public name retained                                                                   |
| `mutation/validate-group-mutation-operation-input.ts`          | `validateGroupMutationOperationInput`                                                                                                                        | new internal name                                                                            |
| `mutation/read-group-mutation.ts`                              | `readGroupMutation`                                                                                                                                          | exact exported name retained                                                                 |
| `mutation/read-group-mutation-related-entries.ts`              | `readGroupMutationRelatedEntries`, `SequentialRelatedEntries`                                                                                                | new internal family                                                                          |
| `mutation/resolve-group-mutation-read-identities.ts`           | `resolveGroupMutationReadIdentities`, `GroupMutationReadIdentities`                                                                                          | new internal family                                                                          |
| `mutation/resolve-group-mutation-target.ts`                    | `mutationTargetPrincipalId`, `mutationTargetSessionId`                                                                                                       | new internal family                                                                          |
...
| `mutation/create-initial-group-mutation.ts`                    | initial group, owner, and presence-summary construction                                                                                                      | new internal family                                                                          |
| `mutation/group-aggregate-mutation-policy.ts`                  | aggregate policy and authority decisions                                                                                                                     | new internal family                                                                          |
| `mutation/compute-group-membership-mutation.ts`                | `computeGroupMembershipMutation` operation family                                                                                                            | new internal family                                                                          |
| `mutation/compute-group-membership-write.ts`                   | `computeGroupMembershipWrite`                                                                                                                                | new internal name                                                                            |
| `mutation/group-membership-mutation-policy.ts`                 | membership policy decisions                                                                                                                                  | new internal family                                                                          |
| `mutation/transition-group-member-lifecycle.ts`                | `transitionGroupMemberLifecycle` and matching member construction/event family                                                                               | new internal family                                                                          |
| `mutation/compute-group-presence-mutation.ts`                  | `computeGroupPresenceMutation` operation family                                                                                                              | new internal family                                                                          |
| `mutation/compute-group-presence-admission.ts`                 | presence-admission computation and identity family                                                                                                           | new internal family                                                                          |
...
| `mutation/validate-computed-group-mutation-write.ts`           | `validateComputedWrite`, `validateComputedOutboxEntries`                                                                                                     | new internal family                                                                          |
| `mutation/validate-computed-roster-facts.ts`                   | `validateComputedRosterFacts`                                                                                                                                | new internal name                                                                            |
| `mutation/validate-group-mutation-result.ts`                   | idempotency-record, receipt, and command-hash validation                                                                                                     | exact public validation names retained                                                       |
...
- The three authorized repairs are implemented and published on the existing
  ...
  passed twice with zero failures. These existing facts do not complete the
  pending Task 8 review, paired performance comparison, Task 9 completion
  gates, publication, or remote gates.
...
Task 8 is drafted and implemented only in the entirely unstaged local candidate;
formal review-fix acceptance remains pending. The local alignment ratchet names
the exact 65-file production owner tree and exact 52-file mirrored test tree,
the three directly owned root test/support files in Section 5, every material
...
and excludes type-only re-exports. No Task 8 tree, commit,
PR-head update, Branch Release Gate, merge, resulting-main, default-workflow, or
later-ledger evidence is recorded before it exists.
...
| Structure implementation | repairs published; final gates pending          | Tasks 0–6 and the two earlier Task 7 review fixes are complete through `1eb3bc7c0bc0c3bbfaaa240f8702f8704e392067` / tree `d9574022a45ae78ce325f60cffc8ef61be16aa73`. The accepted memory/admin repair is published through `e2e109c21ba8f3739e519f1bc1375a00239e039e` / tree `b13847709e9eb69ef0ced04101c00f3bc44488ab`; its final Deno 26/26, focused Vitest 71/71 on three consecutive runs, memory matrix 11/11, auth-session 16/16, and admin-operation 12/12 cohorts passed. The accepted PostgreSQL convergence repair is published through current PR candidate head `7a42c98a31fad1e26bd46622809dc8eb58599c0f` / tree `ac2f0fa7641eb229e0895114e3a2a31930e56563`; its focused 44/44 and 177/177 cohorts passed, and the unchanged 2,748-assertion medium-scale gate passed twice with zero failures. Task 8 acceptance, paired performance, Task 9 completion gates, publication, and remote gates remain pending. |
| Alignment implementation | implemented locally; review-fix round 2 pending | The behavior-neutral Task 8 source ratchet and alignment exist only in the entirely unstaged local candidate. Round 1 fixes preserve the exact trees, independent fixture cohort, and named inputs. Round 2 adds tuple-parameter and runtime re-export cycle regressions and reconciles the deleted interim owners and published repair facts. Fresh independent acceptance, publication, Task 9 gates, and all future remote evidence remain pending.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
zero premature publication evidence. This review remains pending until a fresh
independent reviewer accepts the complete entirely unstaged candidate.
...
recording any pending Task 8 candidate, performance, publication, merge,
workflow, or ledger fact.
