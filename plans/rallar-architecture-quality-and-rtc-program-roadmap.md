...
| RTC performance            | foundation-B03 `verified`; Task 4A `in-progress`; Task 4B/B04/capture held | Foundation PR #150, B01 PR #162, B02 PR #169, and B03 PR #193 are merged. PR #196 merged as `55d7f44c24d0345798a5b2c1dc7ffa0d2b5269af`; resulting-main run 31597501992 succeeded. The human approved exact plan blob `b78e00e982d186264bc5ba6b4b2a943f15a328f3` and explicitly authorized Task 4A. Its exact Section 10 relocation is in progress on `codex/shared-rtc-bench-task-4a`. No benchmark was captured.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Complete semantic-parity, repository, independent-review, and draft-PR publication gates for Task 4A. Keep Task 4B, B04, capture, B06, B07, production, optimization, raw artifacts, and Phase 2 held.                                                                                  |
...
| RTC benchmark organization   | RTC performance plan owner       | `task-4a-in-progress`; later layers held                    | PR #196 merged as current main `55d7f44c24d0345798a5b2c1dc7ffa0d2b5269af`, and resulting-main run 31597501992 succeeded on that exact commit. The human named and approved exact plan blob `b78e00e982d186264bc5ba6b4b2a943f15a328f3`, then explicitly authorized starting. Compatibility review found no material package, contract, or ontology overlap. The exact 49 source dispositions and Task 4A integration are an uncommitted parity candidate on `codex/shared-rtc-bench-task-4a`; no benchmark execution or capture occurred.                                                                                                                        | Complete focused/style/repository gates and independent parity review, publish the separate draft Task 4A PR, and require Branch Release Gate on its exact head. Keep Task 4B, B04, capture, and every later layer inactive.                                                                                                                           |
...
1. Finish the exact Task 4A relocation-parity candidate on
   `codex/shared-rtc-bench-task-4a`: complete local gates, independent review,
   and publication in a separate draft PR.
...
3. Merge Task 4A only after review and exact-head Branch Release Gate success;
   then record its resulting-main commit/tree and successful supported-manifests
   workflow.
