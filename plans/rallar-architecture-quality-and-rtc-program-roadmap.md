...
the thirteen-path RTC B01-B05 plan is published and exactly approved; and this
revision activates only its amended 33-path Section 10 reservation when this
roadmap revision itself reaches `main`. RTC implementation and capture remain
inactive until that publication. Phase 2 remains `not-started`.
...
`codex/rallar-rtc-task1-thirteen-path-roadmap-activation`, after reconciling
current `origin/main` `05cec262b838fb661dcb923152991ce88a28ceac` (tree
`5816137f7587cc581c405680994b1ecf62ef875b`) while retaining Phase 0 closure
...
| RTC performance            | thirteen-path exact plan published and approved; activation pending publication | [PR #109](https://github.com/intact-software-systems/ar-eye-hunter/pull/109) published amended plan blob `585398d6835e2328d6a0f4b82fa8d01605ef6f9a` at feature commit `e490682b4865309ce3a8d54f5339518052d0d7a6`, tree `3ac2604ef7774a45cfe42f223648a68c1e195a0d`; independent feasibility review approved the exact thirteen-path Task 1 split, and all final local plan gates passed. It merged as current main `05cec262b838fb661dcb923152991ce88a28ceac`, tree `5816137f7587cc581c405680994b1ecf62ef875b`, with the exact blob retained. [Human approval comment 5227422413](https://github.com/intact-software-systems/ar-eye-hunter/pull/109#issuecomment-5227422413) is an OWNER-authored GitHub User record with the exact Task 0 text. Resulting-main run 31271274737 attempt 1 is pending on that exact main commit and does not delay this plan-only coordination edit. No benchmark was captured; every earlier Task 1 worktree and the old `d68d511...` prototype remain design input only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Publish this roadmap-only activation. Keep instrumentation and capture inactive until it reaches `main`; keep README/PR #40, B06, B07, production, optimization, raw-artifact publication, and Phase 2 held.                                                                            |
| Cross-program coordination | Phase 0 `verified`; Phase 1 `in-progress`                                       | Phase 0 remains anchored by [PR #77](https://github.com/intact-software-systems/ar-eye-hunter/pull/77). PR #79 merged the reconciled roadmap as `6d4b9653eda00fb0234d2dc419321dd8b7fce7a4`; PR #85 published the original B01-B05 activation as `4192f4fe5d9a735d9dc24791d129e697a247da64`; PR #92 published the six-path activation as `72c426f4c1873d71765da35d26c9d2c0b4b1b6fd`; and PR #101 published the superseded nine-path activation as `7b10146aac7718a807337886d48c8fa5b5145813`. Current `main` is `05cec262b838fb661dcb923152991ce88a28ceac`, tree `5816137f7587cc581c405680994b1ecf62ef875b`, with Ontology Task 1 and thirteen-path RTC plan blob `585398d6835e2328d6a0f4b82fa8d01605ef6f9a` published.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Publish this exact thirteen-path RTC activation as a new roadmap-only PR; do not resume RTC work until its resulting commit is on `main`.                                                                                                                                               |
...
| ---------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Coordination documents | Roadmap coordinator on `codex/rallar-rtc-task1-thirteen-path-roadmap-activation`    | active                                                  | Release after the Phase 1 exit envelope and external evidence are recorded.                                                                                                                                                                                                                                                                                                           |
...
then published the nine-path Task 1 split. [PR #109](https://github.com/intact-software-systems/ar-eye-hunter/pull/109)
now publishes the exact thirteen-path Task 1 split. [RTC Task 0 approval comment
...
`585398d6835e2328d6a0f4b82fa8d01605ef6f9a`. PR #79 published the ontology
activation; PR #89 completed Ontology Task 1; and this revision separately
records the thirteen-path RTC B01-B05 activation, effective only when this
...
- RTC thirteen-path amendment PR #109: feature commit
  ...
  as current main `05cec262b838fb661dcb923152991ce88a28ceac`, tree
  `5816137f7587cc581c405680994b1ecf62ef875b`, with the plan blob retained.
  Resulting-main run 31271274737 attempt 1 is pending on that exact commit and
  does not delay this plan-only coordination edit. [Human approval comment
  5227422413](https://github.com/intact-software-systems/ar-eye-hunter/pull/109#issuecomment-5227422413)
  is an OWNER-authored GitHub User record naming this exact blob and preserving
  separate coordinator activation.
...
statistics and evidence-store owners plus the dedicated CLI test. Current blob
`585398d6835e2328d6a0f4b82fa8d01605ef6f9a` adds the workload-manifest and
evidence-acceptance owners plus their dedicated tests to preserve complete
manifest, acceptance, failure, finalization, semantic-coverage, and
physical-line responsibilities. The RTC plan cannot activate or deactivate
human-program work; this roadmap owns live status, and service-backed B06
...
RTC Phase 1 B01-B05 exact Section 10 reservation for plan blob 585398d6835e2328d6a0f4b82fa8d01605ef6f9a is active; B06, B07, production, optimization, raw-artifact publication, and Phase 2 remain held.

The exact reservation includes
`docs/superpowers/plans/2026-08-06-rallar-rtc-performance-baseline-plan.md` for
its durable progress entry, ignored `tmp/perf/rtc-baseline/**`, and these 33
...
The focused Deno gate names the 11 feature-folder files and the 16 accepted
...
**Current state:** thirteen-path exact plan blob
`585398d6835e2328d6a0f4b82fa8d01605ef6f9a` is published on `main` by PR #109.
Feature commit `e490682b4865309ce3a8d54f5339518052d0d7a6`, tree
`3ac2604ef7774a45cfe42f223648a68c1e195a0d`, passed independent feasibility
review and every final local plan gate. The human merged it as resulting commit
`05cec262b838fb661dcb923152991ce88a28ceac`, tree
`5816137f7587cc581c405680994b1ecf62ef875b`; resulting-main run 31271274737
...
revision records the separate thirteen-path Task 1 and 33-path Section 10
B01-B05 activation, effective only after it reaches `main`; implementation and
capture remain inactive until then. Every earlier Task 1 worktree,
pre-amendment blob, and the old `d68d511...` prototype remains historical
design/review input only.
...
| Phase 1 coordination record  | Roadmap coordinator              | thirteen-path RTC activation publication in progress   | PR #79 merged the Phase 1 coordination record as `6d4b9653eda00fb0234d2dc419321dd8b7fce7a4`; PR #92 published the six-path activation as `72c426f4c1873d71765da35d26c9d2c0b4b1b6fd`; and PR #101 published the superseded nine-path activation as `7b10146aac7718a807337886d48c8fa5b5145813`. Current `main` is `05cec262b838fb661dcb923152991ce88a28ceac`, tree `5816137f7587cc581c405680994b1ecf62ef875b`, with thirteen-path RTC blob `585398d6835e2328d6a0f4b82fa8d01605ef6f9a`. | Publish this one-file thirteen-path RTC activation revision and keep RTC work inactive until it reaches `main`.                                                                                                                                 |
...
| 1C RTC baseline              | `/root/rtc_b01_b05_phase1_owner` | thirteen-path activation recorded; publication pending | PR #109 published exact thirteen-path plan blob `585398d6835e2328d6a0f4b82fa8d01605ef6f9a`; OWNER/User approval comment `5227422413` exactly satisfies Task 0. This roadmap revision records only the exact amended 33-path Section 10 B01-B05 activation. Every earlier Task 1 worktree remains read-only design input and is not completion, source, capture, or benchmark evidence.                                                                                               | After this revision reaches `main`, preserve every held worktree as design input only, establish a fresh clean branch from that exact main, and restart B01-B05 from new RED tests. Until then, do not edit implementation or capture evidence. |
...
2. Publish this roadmap-only thirteen-path RTC B01-B05 activation revision and record
...
3. After the activation revision reaches `main`, preserve every held RTC Task 1
   ...
   33-path Section 10 reservation. Do not resume implementation or capture
