...
the sixteen-path RTC B01-B05 plan is published and exactly approved; and this
revision activates only its amended 36-path Section 10 reservation when this
...
`codex/phase-1-rtc-task1-sixteen-path-roadmap-activation`, after reconciling
current `origin/main` `b35de676d5764406d661e802ecb4bf46b285e660` (tree
`574dd5a621f76d6a3c926a331bc2c5847dfde6c4`) while retaining Phase 0 closure
...
| RTC performance            | sixteen-path exact plan published and approved; activation pending publication | [PR #117](https://github.com/intact-software-systems/ar-eye-hunter/pull/117) published amended plan blob `85858aca6c85e54e48e71aaa6e3b6975d1f851e3` at feature commit `84548e2470318f05cd775e37ba788633502a7ebf`, tree `574dd5a621f76d6a3c926a331bc2c5847dfde6c4`; independent feasibility review approved the exact sixteen-path Task 1 split, and all final local plan gates passed. It merged as current main `b35de676d5764406d661e802ecb4bf46b285e660`, tree `574dd5a621f76d6a3c926a331bc2c5847dfde6c4`, with the exact blob retained. [Human approval comment 5230123447](https://github.com/intact-software-systems/ar-eye-hunter/pull/117#issuecomment-5230123447) is an OWNER-authored GitHub User record with the exact Task 0 text. [Resulting-main run 31295299260](https://github.com/intact-software-systems/ar-eye-hunter/actions/runs/31295299260), attempt 1, succeeded on that exact main commit with all seven jobs successful. No benchmark was captured; every earlier Task 1 worktree and the old `d68d511...` prototype remain design input only.                                                                                                                                                                                                                                                                                                                                                                                                                                    | Publish this roadmap-only activation. Keep instrumentation and capture inactive until it reaches `main`; keep README/PR #40, B06, B07, production, optimization, raw-artifact publication, and Phase 2 held.                                                                            |
| Cross-program coordination | Phase 0 `verified`; Phase 1 `in-progress`                                      | Phase 0 remains anchored by [PR #77](https://github.com/intact-software-systems/ar-eye-hunter/pull/77). PR #79 merged the reconciled roadmap as `6d4b9653eda00fb0234d2dc419321dd8b7fce7a4`; PR #85 published the original B01-B05 activation as `4192f4fe5d9a735d9dc24791d129e697a247da64`; PR #92 published the six-path activation as `72c426f4c1873d71765da35d26c9d2c0b4b1b6fd`; PR #101 published the superseded nine-path activation as `7b10146aac7718a807337886d48c8fa5b5145813`; and PR #111 published the superseded thirteen-path activation as `fdb53f836f7e1fae7b416161a0dbff8d98f91760`. Current `main` is `b35de676d5764406d661e802ecb4bf46b285e660`, tree `574dd5a621f76d6a3c926a331bc2c5847dfde6c4`, with Ontology Task 1 and sixteen-path RTC plan blob `85858aca6c85e54e48e71aaa6e3b6975d1f851e3` published.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Publish this exact sixteen-path RTC activation as a new roadmap-only PR; do not resume RTC work until its resulting commit is on `main`.                                                                                                                                                |
...
| ---------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Coordination documents | Roadmap coordinator on `codex/phase-1-rtc-task1-sixteen-path-roadmap-activation`    | active                                                  | Release after the Phase 1 exit envelope and external evidence are recorded.                                                                                                                                                                                                                                                                                                           |
...
now publishes the exact sixteen-path Task 1 split. [RTC Task 0 approval comment
...
`85858aca6c85e54e48e71aaa6e3b6975d1f851e3`. PR #79 published the ontology
activation; PR #89 completed Ontology Task 1; and this revision separately
records the sixteen-path RTC B01-B05 activation, effective only when this
...
- RTC sixteen-path amendment PR #117: feature commit
  ...
  current main `b35de676d5764406d661e802ecb4bf46b285e660`, tree
...
evidence-acceptance owners plus their dedicated tests. Current blob
`85858aca6c85e54e48e71aaa6e3b6975d1f851e3` adds the real Deno runtime owner,
...
semantic-coverage, and physical-line responsibilities. The RTC plan cannot activate or deactivate
...
RTC Phase 1 B01-B05 exact Section 10 reservation for plan blob 85858aca6c85e54e48e71aaa6e3b6975d1f851e3 is active; B06, B07, production, optimization, raw-artifact publication, and Phase 2 remain held.

The exact reservation includes
`docs/superpowers/plans/2026-08-06-rallar-rtc-performance-baseline-plan.md` for
its durable progress entry, ignored `tmp/perf/rtc-baseline/**`, and these 36
...
The focused Deno gate names the 12 feature-folder files and the 16 accepted
...
**Current state:** sixteen-path exact plan blob
`85858aca6c85e54e48e71aaa6e3b6975d1f851e3` is published on `main` by PR #117.
Feature commit `84548e2470318f05cd775e37ba788633502a7ebf`, tree
`574dd5a621f76d6a3c926a331bc2c5847dfde6c4`, passed independent feasibility
...
`574dd5a621f76d6a3c926a331bc2c5847dfde6c4`; resulting-main run 31295299260
...
revision records the separate sixteen-path Task 1 and 36-path Section 10
...
| Phase 1 coordination record  | Roadmap coordinator              | sixteen-path RTC activation publication in progress   | PR #79 merged the Phase 1 coordination record as `6d4b9653eda00fb0234d2dc419321dd8b7fce7a4`; PR #92 published the six-path activation as `72c426f4c1873d71765da35d26c9d2c0b4b1b6fd`; PR #101 published the superseded nine-path activation as `7b10146aac7718a807337886d48c8fa5b5145813`; and PR #111 published the superseded thirteen-path activation as `fdb53f836f7e1fae7b416161a0dbff8d98f91760`. Current `main` is `b35de676d5764406d661e802ecb4bf46b285e660`, tree `574dd5a621f76d6a3c926a331bc2c5847dfde6c4`, with sixteen-path RTC blob `85858aca6c85e54e48e71aaa6e3b6975d1f851e3`. | Publish this one-file sixteen-path RTC activation revision and keep RTC work inactive until it reaches `main`.                                                                                                                                  |
...
2. Publish this roadmap-only sixteen-path RTC B01-B05 activation revision and record
...
3. After the activation revision reaches `main`, preserve every held RTC Task 1
   ...
   36-path Section 10 reservation. Do not resume implementation or capture
